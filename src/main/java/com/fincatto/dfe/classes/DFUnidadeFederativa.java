...
public enum DFUnidadeFederativa {
    ...
    private DFUnidadeFederativa(final String codigo, final String descricao, final String codigoIbge, String qrCodeHomologacao, String qrCodeProducao) {
        this.codigo = codigo;
    ...
    private DFUnidadeFederativa(final String codigo, final String descricao, final String codigoIbge) {
    ...
    /**
     * Retorna apenas as UF's referente aos estados.
     * @return uma lista com as UF's referente aos estados.
     */
    public static List<DFUnidadeFederativa> getApenasEstados() {
    	List<DFUnidadeFederativa> listUFs = new ArrayList<DFUnidadeFederativa>();
    	for (final DFUnidadeFederativa uf : DFUnidadeFederativa.values()) {
    		if (!(uf.equals(DFUnidadeFederativa.NACIONAL)
    			|| uf.equals(DFUnidadeFederativa.RFB)
    			|| uf.equals(DFUnidadeFederativa.EX))) {
    			listUFs.add(uf);
    		}
    	}
    	return listUFs;

...
/**
 * Configuração básica comum aos Documentos Fiscais.
 *
...
public abstract class DFeConfig {
     ...
     * FileUtils.writeByteArrayToFile(new File("/tmp/producao.cacerts"), DFGeraCadeiaCertificados.geraCadeiaCertificados(DFAmbiente.PRODUCAO, "senha"));
     *
    ...
    public DFTipoEmissao getTipoEmissao() {
        return DFTipoEmissao.EMISSAO_NORMAL;
    }

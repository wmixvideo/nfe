...
public class MDFeRecepcaoSincStub extends org.apache.axis2.client.Stub {
	...
	private void populateAxisService() {
		...
		this._service = new org.apache.axis2.description.AxisService(
				"MDFeRecepcaoSinc" + MDFeRecepcaoSincStub.getUniqueSuffix());
		this.addAnonymousOperations();
		// creating the operations
		org.apache.axis2.description.AxisOperation __operation;
		this._operations = new org.apache.axis2.description.AxisOperation[1];
		__operation = new org.apache.axis2.description.OutInAxisOperation();
		__operation.setName(new javax.xml.namespace.QName("http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeRecepcaoSinc",
				"mdfeRecepcao"));
	...
	public MDFeRecepcaoSincStub(final org.apache.axis2.context.ConfigurationContext configurationContext,
			final java.lang.String targetEndpoint, DFConfig config) throws org.apache.axis2.AxisFault {
	 ...
	 */
	public MDFeRecepcaoSincStub(final org.apache.axis2.context.ConfigurationContext configurationContext,
			final java.lang.String targetEndpoint, final boolean useSeparateListener, DFConfig config)
		...
		this._serviceClient.getOptions()
	 ...
	 */
	public MDFeRecepcaoSincStub(final java.lang.String targetEndpoint, DFConfig config)
			throws org.apache.axis2.AxisFault {
	...
	public com.fincatto.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoSincStub.MdfeRecepcaoSincResult mdfeRecepcaoSinc(
			final com.fincatto.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoSincStub.MdfeDadosMsg mdfeDadosMsg0)
			throws java.rmi.RemoteException {
		org.apache.axis2.context.MessageContext _messageContext = null;
		try {
			final org.apache.axis2.client.OperationClient _operationClient = this._serviceClient
					.createClient(this._operations[0].getName());
			_operationClient.getOptions()
					.setAction("http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeRecepcaoSinc/mdfeRecepcao");
			_operationClient.getOptions().setExceptionToBeThrownOnSOAPFault(true);
			this.addPropertyToOperationClient(_operationClient,
			...
			env = this.toEnvelope(Stub.getFactory(_operationClient.getOptions().getSoapVersionURI()), mdfeDadosMsg0,
					this.optimizeContent(new javax.xml.namespace.QName(
							"http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeRecepcaoSinc", "mdfeRecepcao")),
					new javax.xml.namespace.QName("http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeRecepcaoSinc",
							"mdfeRecepcao"));
			env.build();
			...
			final java.lang.Object object = this.fromOM(_returnEnv.getBody().getFirstElement(),
					com.fincatto.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoSincStub.MdfeRecepcaoSincResult.class,
			...
			if (faultElt != null) {
				if (this.faultExceptionNameMap
						.containsKey(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), "mdfeRecepcao"))) {
					// make the fault by reflection
					try {
						final java.lang.String exceptionClassName = (java.lang.String) this.faultExceptionClassNameMap
								.get(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), "mdfeRecepcao"));
						...
						// message class
						final java.lang.String messageClassName = (java.lang.String) this.faultMessageMap
								.get(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), "mdfeRecepcao"));
	...
	public void startmdfeRecepcao(
			final com.fincatto.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoSincStub.MdfeDadosMsg mdfeDadosMsg0,
			final com.fincatto.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoSincCallbackHandler callback)
			throws java.rmi.RemoteException {
		final org.apache.axis2.client.OperationClient _operationClient = this._serviceClient
				.createClient(this._operations[0].getName());
...
//        this._serviceClient.addHeadersToEnvelope(env);
		...
		_operationClient.setCallback(new org.apache.axis2.client.async.AxisCallback() {
			...
			public void onMessage(final org.apache.axis2.context.MessageContext resultContext) {
				try {
					...
					final java.lang.Object object = MDFeRecepcaoSincStub.this.fromOM(
							resultEnv.getBody().getFirstElement(),
							com.fincatto.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoSincStub.MdfeRecepcaoSincResult.class,
							MDFeRecepcaoSincStub.this.getEnvelopeNamespaces(resultEnv));
					callback.receiveResultmdfeRecepcaoSinc(
							(com.fincatto.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoSincStub.MdfeRecepcaoSincResult) object);
			...
			public void onError(final java.lang.Exception error) {
				if (error instanceof org.apache.axis2.AxisFault) {
					...
					final org.apache.axiom.om.OMElement faultElt = f.getDetail();
					if (faultElt != null) {
						if (MDFeRecepcaoSincStub.this.faultExceptionNameMap.containsKey(
								new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), "mdfeRecepcao"))) {
							// make the fault by reflection
							try {
								final java.lang.String exceptionClassName = (java.lang.String) MDFeRecepcaoSincStub.this.faultExceptionClassNameMap
								...
								// message class
								final java.lang.String messageClassName = (java.lang.String) MDFeRecepcaoSincStub.this.faultMessageMap
										.get(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(),
												"mdfeRecepcao"));
								final java.lang.Class messageClass = java.lang.Class.forName(messageClassName);
								final java.lang.Object messageObject = MDFeRecepcaoSincStub.this.fromOM(faultElt,
										messageClass, null);
								final java.lang.reflect.Method m = exceptionClass.getMethod("setFaultMessage",
										messageClass);
								m.invoke(ex, messageObject);
								callback.receiveErrormdfeRecepcaoSinc(
	...
	public static class ExtensionMapper {
		...
		public static java.lang.Object getTypeObject(final java.lang.String namespaceURI,
			...
			if ("http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeRecepcaoSinc".equals(namespaceURI)
	...
	public static class MdfeCabecMsg implements org.apache.axis2.databinding.ADBBean {
		 ...
		 * Namespace URI = http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeRecepcaoSinc
		...
		public void addExtraAttributes(final org.apache.axiom.om.OMAttribute param) {
			...
			final java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil
					.toList(this.localExtraAttributes);
			list.add(param);
			this.localExtraAttributes = (org.apache.axiom.om.OMAttribute[]) list
					.toArray(new org.apache.axiom.om.OMAttribute[0]);
		}
		...
		public void serialize(final javax.xml.namespace.QName parentQName,
			...
			if (serializeType) {
				...
				if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
					...
					this.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "mdfeCabecMsg",
							xmlWriter);
				}
			}
			if (this.localExtraAttributes != null) {
				for (final OMAttribute localExtraAttribute : this.localExtraAttributes) {
					this.writeAttribute(localExtraAttribute.getNamespace().getName(),
							localExtraAttribute.getLocalName(), localExtraAttribute.getAttributeValue(), xmlWriter);
				}
			}
				...
				try {
					...
					for (int i = 0; i < reader.getAttributeCount(); i++) {
						if (!handledAttributes.contains(reader.getAttributeLocalName(i))) {
							...
							final org.apache.axiom.om.OMFactory factory = org.apache.axiom.om.OMAbstractFactory
									.getOMFactory();
							final org.apache.axiom.om.OMAttribute attr = factory.createOMAttribute(
					...
					if (reader.isStartElement() && new javax.xml.namespace.QName(
							"http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeRecepcaoSinc", "cUF")
					...
					if (reader.isStartElement() && new javax.xml.namespace.QName(
							"http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeRecepcaoSinc", "versaoDados")
							.equals(reader.getName())) {
						nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
						if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
							throw new org.apache.axis2.databinding.ADBException(
	...
	public static class MdfeRecepcaoSincResult implements org.apache.axis2.databinding.ADBBean {
		...
		public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
				"http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeRecepcaoSinc", "mdfeRecepcaoResult", "ns2");
		...
		public org.apache.axiom.om.OMElement getOMElement(final javax.xml.namespace.QName parentQName,
				final org.apache.axiom.om.OMFactory factory) {
			final org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
					MdfeRecepcaoSincResult.MY_QNAME);
		...
		public void serialize(final javax.xml.namespace.QName parentQName,
			...
			if (serializeType) {
				...
				if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
					this.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
							namespacePrefix + ":mdfeRecepcaoResult", xmlWriter);
				} else {
					this.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
							"mdfeRecepcaoResult", xmlWriter);
				}
			}
		...
		public static class Factory {
			 ...
			 */
			@SuppressWarnings({ "unused", "rawtypes" })
			public static MdfeRecepcaoSincResult parse(final javax.xml.stream.XMLStreamReader reader)
					throws java.lang.Exception {
	...
	public static class MdfeCabecMsgE implements org.apache.axis2.databinding.ADBBean {
		...
		public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
				"http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeRecepcaoSinc", "mdfeCabecMsg", "ns2");
		...
		public static class Factory {
			 ...
			 */
			@SuppressWarnings({ "unused", "rawtypes" })
			public static MdfeCabecMsgE parse(final javax.xml.stream.XMLStreamReader reader)
					throws java.lang.Exception {
				...
				try {
					...
					while (!reader.isEndElement()) {
						if (reader.isStartElement()) {
							if (reader.isStartElement() && new javax.xml.namespace.QName(
									"http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeRecepcaoSinc", "mdfeCabecMsg")
									.equals(reader.getName())) {
	...
	public static class MdfeDadosMsg implements org.apache.axis2.databinding.ADBBean {
		...
		public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
				"http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeRecepcaoSinc", "mdfeDadosMsg", "ns2");
		...
		public void serialize(final javax.xml.namespace.QName parentQName,
			...
			if (serializeType) {
				...
				if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
					...
					this.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "mdfeDadosMsg",
							xmlWriter);
				}
			}
	...
	// toOM(com.fincatto.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoStub.MdfeDadosMsg
	// param, boolean optimizeContent) throws org.apache.axis2.AxisFault {
	// try {
	// return
	// param.getOMElement(com.fincatto.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoStub.MdfeDadosMsg.MY_QNAME,
	...
	//
	// private org.apache.axiom.om.OMElement
	// toOM(com.fincatto.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoStub.MdfeRecepcaoLoteResult
	// param, boolean optimizeContent) throws org.apache.axis2.AxisFault {
	// try {
	// return
	// param.getOMElement(com.fincatto.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoStub.MdfeRecepcaoLoteResult.MY_QNAME,
	// org.apache.axiom.om.OMAbstractFactory.getOMFactory());
	// } catch (org.apache.axis2.databinding.ADBException e) {
	// throw org.apache.axis2.AxisFault.makeFault(e);
	// }
	...
	private org.apache.axiom.soap.SOAPEnvelope toEnvelope(final org.apache.axiom.soap.SOAPFactory factory,
			final com.fincatto.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoSincStub.MdfeDadosMsg param,
		...
		emptyEnvelope.getBody().addChild(param.getOMElement(
				com.fincatto.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoSincStub.MdfeDadosMsg.MY_QNAME,
				factory));
	...
	private java.lang.Object fromOM(final org.apache.axiom.om.OMElement param, final java.lang.Class type,
		...
		try {
			if (com.fincatto.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoSincStub.MdfeDadosMsg.class
					.equals(type)) {
				return com.fincatto.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoSincStub.MdfeDadosMsg.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());
			}
			if (com.fincatto.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoSincStub.MdfeRecepcaoSincResult.class
					.equals(type)) {
				return com.fincatto.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoSincStub.MdfeRecepcaoSincResult.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());
			}
			if (com.fincatto.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoSincStub.MdfeCabecMsgE.class
					.equals(type)) {
				return com.fincatto.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoSincStub.MdfeCabecMsgE.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());
			}

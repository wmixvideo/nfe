...
public class MDFInfoInformacoesCTe {
    ...
    private List<MDFInfoInformacoesCTeTipoUnidadeTransporte> informacoesUnidadeTransporte;
    ...
    public List<MDFInfoInformacoesCTeTipoUnidadeTransporte> getInformacoesUnidadeTransporte() {
        return informacoesUnidadeTransporte;
    }

    public void setInformacoesUnidadeTransporte(List<MDFInfoInformacoesCTeTipoUnidadeTransporte> informacoesUnidadeTransporte) {

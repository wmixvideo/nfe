...
public class NFEnviaEventoInfoEfetPagIntegral extends DFBase {
    ...
    private List<NFEventoInfoEfetivoPagIntegral> evento;
    ...
    public List<NFEventoInfoEfetivoPagIntegral> getEvento() {
        return this.evento;
    }

    public void setEvento(final List<NFEventoInfoEfetivoPagIntegral> evento) {

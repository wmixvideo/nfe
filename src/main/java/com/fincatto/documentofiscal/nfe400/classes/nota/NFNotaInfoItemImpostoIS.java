...
public class NFNotaInfoItemImpostoIS extends DFBase {
	...
	public void getVBCIS(BigDecimal vBCIS) {
		this.vBCIS = DFBigDecimalValidador.tamanho13Com2CasasDecimais(vBCIS,
				"Valor da Base de Cálculo do Imposto Seletivo");
	}

    public void setVBCIS(final BigDecimal vBCIS) {
        this.vBCIS = DFBigDecimalValidador.tamanho15Com2CasasDecimais(vBCIS, "Valor da Base de Cálculo do Imposto Seletivo");
    }
	...
	public void setPISEspec(BigDecimal pISEspec) {
		this.pISEspec = DFBigDecimalValidador.tamanho7ComAte4CasasDecimais(pISEspec,
    ...
    public void setVIS(final BigDecimal vIS) {
        this.vIS = DFBigDecimalValidador.tamanho15Com2CasasDecimais(vIS, "Valor do Imposto Seletivo");
    }
}

...
public class NFEnviaEventoNaoFornecimentoPagamentoAntecipado extends DFBase {
    ...
    private List<NFEventoNaoFornecimentoPagamentoAntecipado> evento;
    ...
    public List<NFEventoNaoFornecimentoPagamentoAntecipado> getEvento() {
        return this.evento;
    }

    public void setEvento(final List<NFEventoNaoFornecimentoPagamentoAntecipado> evento) {

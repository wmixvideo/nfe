...
public class NFProtocoloEventoSolicApropriCreditoBensAtdAdquirente extends DFBase {

    @Attribute(name = "versao")
    private String versao;

    @Element(name = "evento")
    private NFEventoSolicApropriCreditoBensAtdAdquirente evento;
    ...
    public NFEventoSolicApropriCreditoBensAtdAdquirente getEvento() {
        return evento;
    }

    public void setEvento(NFEventoSolicApropriCreditoBensAtdAdquirente evento) {
        this.evento = evento;
    }

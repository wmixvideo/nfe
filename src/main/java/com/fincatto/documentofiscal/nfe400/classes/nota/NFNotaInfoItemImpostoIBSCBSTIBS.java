...
public class NFNotaInfoItemImpostoIBSCBSTIBS extends DFBase {
	...
	public static class GIBSUF extends DFBase {
		...
		public void setPIBSUF(BigDecimal pIBSUF) {
			this.pIBSUF = DFBigDecimalValidador.tamanho7ComAte4CasasDecimais(pIBSUF,
	...
	public static class GIBSMun extends DFBase {
		...
		public void setPIBSMun(BigDecimal pIBSMun) {
			this.pIBSMun = DFBigDecimalValidador.tamanho7ComAte4CasasDecimais(pIBSMun,
	...
	public static class GTribRegular extends DFBase {
		...
		public void setPAliqEfetRegIBSUF(BigDecimal pAliqEfetRegIBSUF) {
			this.pAliqEfetRegIBSUF = DFBigDecimalValidador.tamanho7ComAte4CasasDecimais(pAliqEfetRegIBSUF,
		...
		public void setVTribRegIBSUF(BigDecimal vTribRegIBSUF) {
			this.vTribRegIBSUF = DFBigDecimalValidador.tamanho13Com2CasasDecimais(vTribRegIBSUF,
		...
		public void setPAliqEfetRegIBSMun(BigDecimal pAliqEfetRegIBSMun) {
			this.pAliqEfetRegIBSMun = DFBigDecimalValidador.tamanho7ComAte4CasasDecimais(pAliqEfetRegIBSMun,
		...
		public void setVTribRegIBSMun(BigDecimal vTribRegIBSMun) {
			this.vTribRegIBSMun = DFBigDecimalValidador.tamanho13Com2CasasDecimais(vTribRegIBSMun,
		...
		public void setPAliqEfetRegCBS(BigDecimal pAliqEfetRegCBS) {
			this.pAliqEfetRegCBS = DFBigDecimalValidador.tamanho7ComAte4CasasDecimais(pAliqEfetRegCBS,
	...
	public static class GCredPres extends DFBase {
		...
		public void setPCredPres(BigDecimal pCredPres) {
			this.pCredPres = DFBigDecimalValidador.tamanho7ComAte4CasasDecimais(pCredPres,
		...
		public void setVCredPresCondSus(BigDecimal vCredPresCondSus) {
			this.vCredPresCondSus = DFBigDecimalValidador.tamanho13Com2CasasDecimais(vCredPresCondSus,
	...
	public static class GTribCompraGov extends DFBase {
		...
		public void setPAliqIBSUF(BigDecimal pAliqIBSUF) {
			this.pAliqIBSUF = DFBigDecimalValidador.tamanho7ComAte4CasasDecimais(pAliqIBSUF,
		...
		public void setVTribIBSUF(BigDecimal vTribIBSUF) {
			this.vTribIBSUF = DFBigDecimalValidador.tamanho13Com2CasasDecimais(vTribIBSUF,
		...
		public void setPAliqIBSMun(BigDecimal pAliqIBSMun) {
			this.pAliqIBSMun = DFBigDecimalValidador.tamanho7ComAte4CasasDecimais(pAliqIBSMun,
					"Alíquota do IBS de competência do Município");
		}
		...
		public void setVTribIBSMun(BigDecimal vTribIBSMun) {
			this.vTribIBSMun = DFBigDecimalValidador.tamanho13Com2CasasDecimais(vTribIBSMun,
		...
		public void setVTribCBS(BigDecimal vTribCBS) {
			this.vTribCBS = DFBigDecimalValidador.tamanho13Com2CasasDecimais(vTribCBS,
...
// UB26 // UB45
	public static class GRed extends DFBase {
		...
		public void setPRedAliq(BigDecimal pRedAliq) {
			this.pRedAliq = DFBigDecimalValidador.tamanho7ComAte4CasasDecimais(pRedAliq,
		...
		public void setPAliqEfet(BigDecimal pAliqEfet) {
			this.pAliqEfet = DFBigDecimalValidador.tamanho7ComAte4CasasDecimais(pAliqEfet,

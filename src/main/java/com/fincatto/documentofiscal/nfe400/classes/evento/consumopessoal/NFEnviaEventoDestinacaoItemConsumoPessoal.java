...
public class NFEnviaEventoDestinacaoItemConsumoPessoal extends DFBase {
    ...
    private List<NFEventoDestinacaoItemConsumoPessoal> evento;
    ...
    public List<NFEventoDestinacaoItemConsumoPessoal> getEvento() {
        return this.evento;
    }

    public void setEvento(final List<NFEventoDestinacaoItemConsumoPessoal> evento) {

...
public class NFEnviaEventoSolicitacaoApropriacaoCreditoCombustivel extends DFBase {
    ...
    private List<NFEventoSolicitacaoApropriacaoCreditoCombustivel> evento;
    ...
    public List<NFEventoSolicitacaoApropriacaoCreditoCombustivel> getEvento() {
        return this.evento;
    }

    public void setEvento(final List<NFEventoSolicitacaoApropriacaoCreditoCombustivel> evento) {

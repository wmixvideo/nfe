...
public class NFProtocoloEventoInfoEfetPagIntegral extends DFBase {

    @Attribute(name = "versao")
    private String versao;

    @Element(name = "evento")
    private NFEventoInfoEfetivoPagIntegral evento;
    ...
    public NFEventoInfoEfetivoPagIntegral getEvento() {
        return evento;
    }

    public void setEvento(NFEventoInfoEfetivoPagIntegral evento) {
        this.evento = evento;
    }

...
public class NFEndereco extends DFBase {
    ...
    private void verificaDestinoOperacao(DFPais codigoPais) {
        if (this.uf != null && this.uf.equals(DFUnidadeFederativa.EX.getCodigo()) && codigoPais.equals(DFPais.BRASIL)) {
            throw new IllegalStateException("Opera\u00E7\u00E3o com Exterior e pa\u00EDs de destino igual a Brasil");
        } else if (this.uf != null && !this.uf.equals(DFUnidadeFederativa.EX.getCodigo()) && !codigoPais.equals(DFPais.BRASIL)) {

...
public class NFProtocoloEventoDestinacaoItemConsumoPessoal extends DFBase {

    @Attribute(name = "versao")
    private String versao;

    @Element(name = "evento")
    private NFEventoDestinacaoItemConsumoPessoal evento;
    ...
    public NFEventoDestinacaoItemConsumoPessoal getEvento() {
        return evento;
    }

    public void setEvento(NFEventoDestinacaoItemConsumoPessoal evento) {
        this.evento = evento;
    }

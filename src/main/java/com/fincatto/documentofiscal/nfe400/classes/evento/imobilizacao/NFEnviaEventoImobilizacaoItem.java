...
public class NFEnviaEventoImobilizacaoItem extends DFBase {
    ...
    private List<NFEventoImobilizacaoItem> evento;
    ...
    public List<NFEventoImobilizacaoItem> getEvento() {
        return this.evento;
    }

    public void setEvento(final List<NFEventoImobilizacaoItem> evento) {

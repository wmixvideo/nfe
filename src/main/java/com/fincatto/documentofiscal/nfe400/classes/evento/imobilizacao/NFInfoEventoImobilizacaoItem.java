...
public class NFInfoEventoImobilizacaoItem extends DFBase {
    ...
    private NFDetEventoImobilizacaoItem detalhesEvento;
    ...
    public NFDetEventoImobilizacaoItem getDetalhesEvento() {
        return this.detalhesEvento;
    }

    public void setDetalhesEvento(final NFDetEventoImobilizacaoItem detalhesEvento) {

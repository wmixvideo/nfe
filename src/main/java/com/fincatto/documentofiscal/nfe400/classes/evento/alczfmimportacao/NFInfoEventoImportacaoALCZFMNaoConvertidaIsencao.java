...
public class NFInfoEventoImportacaoALCZFMNaoConvertidaIsencao extends DFBase {
    ...
    private NFDetEventoImportacaoALCZFMNaoConvertidaIsencao detalhesEvento;
    ...
    public NFDetEventoImportacaoALCZFMNaoConvertidaIsencao getDetalhesEvento() {
        return this.detalhesEvento;
    }

    public void setDetalhesEvento(final NFDetEventoImportacaoALCZFMNaoConvertidaIsencao detalhesEvento) {

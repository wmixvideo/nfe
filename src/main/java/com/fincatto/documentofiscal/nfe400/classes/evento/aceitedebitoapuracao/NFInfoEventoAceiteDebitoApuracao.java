...
public class NFInfoEventoAceiteDebitoApuracao  extends DFBase {
    ...
    private NFInfoAceiteDebitoApuracao aceiteDebitoApuracao;
    ...
    public NFInfoAceiteDebitoApuracao getAceiteDebitoApuracao() {
        return this.aceiteDebitoApuracao;
    }

    public void setAceiteDebitoApuracao(final NFInfoAceiteDebitoApuracao aceiteDebitoApuracao) {
        this.aceiteDebitoApuracao = aceiteDebitoApuracao;
    }

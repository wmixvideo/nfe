...
public class NFInfoEventoDestinacaoItemConsumoPessoal extends DFBase {
    ...
    private NFDetEventoDestinacaoItemConsumoPessoal detalhesEvento;
    ...
    public NFDetEventoDestinacaoItemConsumoPessoal getDetalhesEvento() {
        return this.detalhesEvento;
    }

    public void setDetalhesEvento(final NFDetEventoDestinacaoItemConsumoPessoal detalhesEvento) {

...
public class NFEnviaEventoImportacaoALCZFMNaoConvertidaIsencao extends DFBase {
    ...
    private List<NFEventoImportacaoALCZFMNaoConvertidaIsencao> evento;
    ...
    public List<NFEventoImportacaoALCZFMNaoConvertidaIsencao> getEvento() {
        return this.evento;
    }

    public void setEvento(final List<NFEventoImportacaoALCZFMNaoConvertidaIsencao> evento) {

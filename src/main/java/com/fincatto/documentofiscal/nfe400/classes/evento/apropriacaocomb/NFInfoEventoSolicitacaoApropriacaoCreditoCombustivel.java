...
public class NFInfoEventoSolicitacaoApropriacaoCreditoCombustivel extends DFBase {
    ...
    private NFDetEventoSolicitacaoApropriacaoCreditoCombustivel detalhesEvento;
    ...
    public NFDetEventoSolicitacaoApropriacaoCreditoCombustivel getDetalhesEvento() {
        return this.detalhesEvento;
    }

    public void setDetalhesEvento(final NFDetEventoSolicitacaoApropriacaoCreditoCombustivel detalhesEvento) {

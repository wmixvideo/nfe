...
public class NFProtocoloEventoAtualizacaoDataPrevisaoEntrega extends DFBase {

    @Attribute(name = "versao")
    private String versao;

    @Element(name = "evento")
    private NFEventoAtualizacaoDataPrevisaoEntrega evento;
    ...
    public NFEventoAtualizacaoDataPrevisaoEntrega getEvento() {
        return evento;
    }

    public void setEvento(NFEventoAtualizacaoDataPrevisaoEntrega evento) {
        this.evento = evento;
    }

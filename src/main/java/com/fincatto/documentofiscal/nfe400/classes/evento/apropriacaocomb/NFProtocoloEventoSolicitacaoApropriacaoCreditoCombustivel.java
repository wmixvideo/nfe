...
public class NFProtocoloEventoSolicitacaoApropriacaoCreditoCombustivel extends DFBase {

    @Attribute(name = "versao")
    private String versao;

    @Element(name = "evento")
    private NFEventoSolicitacaoApropriacaoCreditoCombustivel evento;
    ...
    public NFEventoSolicitacaoApropriacaoCreditoCombustivel getEvento() {
        return evento;
    }

    public void setEvento(NFEventoSolicitacaoApropriacaoCreditoCombustivel evento) {
        this.evento = evento;
    }

...
public class NFInfoEventoSolicApropriCreditoBensAtdAdquirente extends DFBase {
    ...
    private NFDetEventoSolicApropriCreditoBensAtdAdquirente detalhesEvento;
    ...
    public NFDetEventoSolicApropriCreditoBensAtdAdquirente getDetalhesEvento() {
        return this.detalhesEvento;
    }

    public void setDetalhesEvento(final NFDetEventoSolicApropriCreditoBensAtdAdquirente detalhesEvento) {

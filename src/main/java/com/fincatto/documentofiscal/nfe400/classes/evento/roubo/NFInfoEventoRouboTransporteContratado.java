...
public class NFInfoEventoRouboTransporteContratado extends DFBase {
    ...
    private NFDetEventoRouboTransporteContratado detalhesEvento;
    ...
    public NFDetEventoRouboTransporteContratado getDetalhesEvento() {
        return this.detalhesEvento;
    }

    public void setDetalhesEvento(final NFDetEventoRouboTransporteContratado detalhesEvento) {

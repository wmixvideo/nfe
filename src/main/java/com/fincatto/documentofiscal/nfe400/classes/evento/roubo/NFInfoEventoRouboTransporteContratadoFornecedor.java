...
public class NFInfoEventoRouboTransporteContratadoFornecedor extends DFBase {
    ...
    private NFDetEventoRouboTransporteContratadoFornecedor detalhesEvento;
    ...
    public NFDetEventoRouboTransporteContratadoFornecedor getDetalhesEvento() {
        return this.detalhesEvento;
    }

    public void setDetalhesEvento(final NFDetEventoRouboTransporteContratadoFornecedor detalhesEvento) {

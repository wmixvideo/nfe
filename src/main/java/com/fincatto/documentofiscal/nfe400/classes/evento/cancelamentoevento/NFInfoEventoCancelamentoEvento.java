...
public class NFInfoEventoCancelamentoEvento extends DFBase {
    ...
    public void setId(final String id) {
        DFStringValidador.exatamente54(id, "Id Evento Cancelamento de Evento");
        this.id = id;
    }
    ...
    public void setChave(final String chave) {
        DFStringValidador.exatamente44N(chave, "Info Evento Cancelamento de Evento - Chave de Acesso");
        this.chave = chave;
    }
    ...
    public void setCodigoEvento(final String codigoEvento) {
        DFStringValidador.exatamente6N(codigoEvento, "Info Evento Cancelamento de Evento - Código do Evento");
    ...
    public void setNumeroSequencialEvento(final int numeroSequencialEvento) {
        DFIntegerValidador.tamanho1a2(numeroSequencialEvento, "Numero Sequencial Evento a ser Cancelado");

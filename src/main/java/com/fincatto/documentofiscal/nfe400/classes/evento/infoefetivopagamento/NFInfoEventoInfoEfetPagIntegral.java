...
public class NFInfoEventoInfoEfetPagIntegral extends DFBase {
    ...
    private NFDetEventoInfoEfetPagIntegral detalhesEvento;
    ...
    public NFDetEventoInfoEfetPagIntegral getDetalhesEvento() {
        return this.detalhesEvento;
    }

    public void setDetalhesEvento(final NFDetEventoInfoEfetPagIntegral detalhesEvento) {

...
public class NFEnviaEventoRouboTransporteContratadoFornecedor extends DFBase {
    ...
    private List<NFEventoRouboTransporteContratadoFornecedor> evento;
    ...
    public List<NFEventoRouboTransporteContratadoFornecedor> getEvento() {
        return this.evento;
    }

    public void setEvento(final List<NFEventoRouboTransporteContratadoFornecedor> evento) {

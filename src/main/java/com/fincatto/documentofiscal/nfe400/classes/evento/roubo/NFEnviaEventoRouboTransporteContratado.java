...
public class NFEnviaEventoRouboTransporteContratado extends DFBase {
    ...
    private List<NFEventoRouboTransporteContratado> evento;
    ...
    public List<NFEventoRouboTransporteContratado> getEvento() {
        return this.evento;
    }

    public void setEvento(final List<NFEventoRouboTransporteContratado> evento) {

...
public class NFInfoEventoSolicitacaoApropriacaoCreditoPresumido extends DFBase {
    ...
    private NFDetEventoSolicitacaoApropriacaoCreditoPresumido detalhesEvento;
    ...
    public NFDetEventoSolicitacaoApropriacaoCreditoPresumido getDetalhesEvento() {
        return this.detalhesEvento;
    }

    public void setDetalhesEvento(final NFDetEventoSolicitacaoApropriacaoCreditoPresumido detalhesEvento) {

...
public class NFEnviaEventoSolicitacaoApropriacaoCreditoPresumido extends DFBase {
    ...
    private List<NFEventoSolicitacaoApropriacaoCreditoPresumido> evento;
    ...
    public List<NFEventoSolicitacaoApropriacaoCreditoPresumido> getEvento() {
        return this.evento;
    }

    public void setEvento(final List<NFEventoSolicitacaoApropriacaoCreditoPresumido> evento) {

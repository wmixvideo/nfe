...
public class NFProtocoloEventoRouboTransporteContratado extends DFBase {

    @Attribute(name = "versao")
    private String versao;

    @Element(name = "evento")
    private NFEventoRouboTransporteContratado evento;
    ...
    public NFEventoRouboTransporteContratado getEvento() {
        return evento;
    }

    public void setEvento(NFEventoRouboTransporteContratado evento) {
        this.evento = evento;
    }

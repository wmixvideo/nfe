...
public class MTCadConsultaCadastro4Stub extends org.apache.axis2.client.Stub {
	 ...
	 */
	public MTCadConsultaCadastro4Stub(org.apache.axis2.context.ConfigurationContext configurationContext,
		...
		try {
			...
			env = this.toEnvelope(getFactory(_operationClient.getOptions().getSoapVersionURI()), consultaCadastro0,
					optimizeContent(new javax.xml.namespace.QName(
							"http://www.portalfiscal.inf.br/nfe/wsdl/CadConsultaCadastro4", "consultaCadastro")),
					new javax.xml.namespace.QName("http://www.portalfiscal.inf.br/nfe/wsdl/CadConsultaCadastro4",
							"consultaCadastro"));
			...
			Object object = fromOM(_returnEnv.getBody().getFirstElement(), NfeResultMsg.class);
...
//    }
	...
	public static class ExtensionMapper {
		public static Object getTypeObject(String namespaceURI, String typeName,
			...
			if ("http://www.portalfiscal.inf.br/nfe/wsdl/CadConsultaCadastro4".equals(namespaceURI)
	...
	public static class NfeResultMsg implements org.apache.axis2.databinding.ADBBean {
		...
		public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
			...
			if (localConsultaCadastroResultTracker) {
				...
				localConsultaCadastroResult.serialize(
						new javax.xml.namespace.QName("http://www.portalfiscal.inf.br/nfe/wsdl/CadConsultaCadastro4",
			...
			public static NfeResultMsg parse(javax.xml.stream.XMLStreamReader reader) throws Exception {
				...
				try {
					...
					if ((reader.isStartElement() && new javax.xml.namespace.QName(
							"http://www.portalfiscal.inf.br/nfe/wsdl/CadConsultaCadastro4", "consultaCadastroResult")
							.equals(reader.getName()))
							|| new javax.xml.namespace.QName("", "consultaCadastroResult").equals(reader.getName())) {
	...
	public static class ConsultaCadastroResult_type0 implements org.apache.axis2.databinding.ADBBean {
		...
		public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
			...
			if (serializeType) {
				...
				if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
					writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
							namespacePrefix + ":consultaCadastroResult_type0", xmlWriter);
				} else {
					writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
					...
					if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
						...
						if (fullTypeName != null) {
							...
							if (!"consultaCadastroResult_type0".equals(type)) {
								...
								return (ConsultaCadastroResult_type0) ExtensionMapper.getTypeObject(nsUri, type,
										reader);
							}
						}
					}
	...
	public static class NfeDadosMsg_type0 implements org.apache.axis2.databinding.ADBBean {
		 ...
		 * http://www.portalfiscal.inf.br/nfe/wsdl/CadConsultaCadastro4 Namespace Prefix
		 * = ns1
		 */
		...
		public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
			...
			if (serializeType) {
				...
				if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
					...
					writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "consultaCadastro",
							xmlWriter);
				}
			}
			...
			if (localNfeDadosMsgTracker) {
				...
				localNfeDadosMsg.serialize(new javax.xml.namespace.QName(
						"http://www.portalfiscal.inf.br/nfe/wsdl/CadConsultaCadastro4", "nfeDadosMsg"), xmlWriter);
			}
			...
			public static ConsultaCadastro parse(javax.xml.stream.XMLStreamReader reader) throws Exception {
				...
				try {
					...
					if ((reader.isStartElement() && new javax.xml.namespace.QName(
							...
							.equals(reader.getName()))
							|| new javax.xml.namespace.QName("", "nfeDadosMsg").equals(reader.getName())) {

...
public class NFeRetAutorizacao4Stub extends org.apache.axis2.client.Stub {
     ...
     * @see com.fincatto.documentofiscal.nfe400.webservices.gerado.NFeRetAutorizacao4#nfeRetAutorizacaoLote
     * @param nfeDadosMsg0
     */
     ...
     * @see com.fincatto.documentofiscal.nfe400.webservices.gerado.NFeRetAutorizacao4#startnfeRetAutorizacaoLote
     * @param nfeDadosMsg0
     */
    public void startnfeRetAutorizacaoLote(final NFeRetAutorizacao4Stub.NfeDadosMsg nfeDadosMsg0, final NFeRetAutorizacao4CallbackHandler callback) throws java.rmi.RemoteException {
        final org.apache.axis2.client.OperationClient _operationClient = this._serviceClient.createClient(this._operations[0].getName());
        _operationClient.getOptions().setAction("http://www.portalfiscal.inf.br/nfe/wsdl/NFeRetAutorizacao4/nfeRetAutorizacaoLote");
        _operationClient.getOptions().setExceptionToBeThrownOnSOAPFault(true);
        ...
        _operationClient.setCallback(new org.apache.axis2.client.async.AxisCallback() {
            ...
            public void onMessage(final org.apache.axis2.context.MessageContext resultContext) {
                try {
                    ...
                    final java.lang.Object object = NFeRetAutorizacao4Stub.this.fromOM(resultEnv.getBody().getFirstElement(), NFeRetAutorizacao4Stub.NfeResultMsg.class);
            ...
            public void onError(final java.lang.Exception error) {
                if (error instanceof org.apache.axis2.AxisFault) {
                    ...
                    if (faultElt != null) {
                        if (NFeRetAutorizacao4Stub.this.faultExceptionNameMap.containsKey(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), "nfeRetAutorizacaoLote"))) {
                            // make the fault by reflection
                            try {
                                final java.lang.String exceptionClassName = (java.lang.String) NFeRetAutorizacao4Stub.this.faultExceptionClassNameMap.get(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), "nfeRetAutorizacaoLote"));
                                final java.lang.Class exceptionClass = java.lang.Class.forName(exceptionClassName);
                                final java.lang.reflect.Constructor constructor = exceptionClass.getConstructor(java.lang.String.class);
                                final java.lang.Exception ex = (java.lang.Exception) constructor.newInstance(f.getMessage());

                                // message class
                                final java.lang.String messageClassName = (java.lang.String) NFeRetAutorizacao4Stub.this.faultMessageMap.get(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), "nfeRetAutorizacaoLote"));
                                final java.lang.Class messageClass = java.lang.Class.forName(messageClassName);
                                final java.lang.Object messageObject = NFeRetAutorizacao4Stub.this.fromOM(faultElt, messageClass);
                                final java.lang.reflect.Method m = exceptionClass.getMethod("setFaultMessage", new java.lang.Class[] { messageClass });
                                m.invoke(ex, new java.lang.Object[] { messageObject });
    ...
    abstract class NFeRetAutorizacao4CallbackHandler {
         ...
         */
        public NFeRetAutorizacao4CallbackHandler(final Object clientData) {
        ...
        /**
         * auto generated Axis2 call back method for nfeRetAutorizacaoLote method override this method for handling normal response from nfeRetAutorizacaoLote operation
         */
        public void receiveResultnfeRetAutorizacaoLote(final NfeResultMsg result) {
        }

        /**
         * auto generated Axis2 Error handler override this method for handling error response from nfeRetAutorizacaoLote operation
         */
        public void receiveErrornfeRetAutorizacaoLote(final java.lang.Exception e) {
        }
    }
}

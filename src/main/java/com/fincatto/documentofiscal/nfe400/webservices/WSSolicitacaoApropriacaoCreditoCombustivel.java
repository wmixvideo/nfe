 ...
 */
class WSSolicitacaoApropriacaoCreditoCombustivel extends AbstractWSEvento implements DFLog {
    private static final BigDecimal VERSAO_LAYOUT = new BigDecimal("1.00");
    private static final String DESCRICAO_EVENTO = "Solicita\u00E7\u00E3o de Apropria\u00E7\u00E3o de Cr\u00E9dito de Combust\u00EDvel";
     ...
     * @return {@link NFEnviaEventoSolicitacaoApropriacaoCreditoCombustivel} com os dados do evento preenchidos
     */
    protected NFEnviaEventoSolicitacaoApropriacaoCreditoCombustivel gerarDadosXml() {
        final NFDetEventoSolicitacaoApropriacaoCreditoCombustivel detEvento = new NFDetEventoSolicitacaoApropriacaoCreditoCombustivel();
        detEvento.setDescricaoEvento(WSSolicitacaoApropriacaoCreditoCombustivel.DESCRICAO_EVENTO);
        detEvento.setVersao(WSSolicitacaoApropriacaoCreditoCombustivel.VERSAO_LAYOUT);
        detEvento.setTipoAutor(NFEventoTipoAutor.EMPRESA_DESTINADA);
        detEvento.setUfAutorEvento(super.ufAutorEvento);
        detEvento.setVersaoAplicativo(WSSolicitacaoApropriacaoCreditoCombustivel.VERSAO_LAYOUT.toString());
        detEvento.setGruposConsumoCombustivel(this.gruposComsumoCombustivel);
     ...
     * {@link NFEnviaEventoSolicitacaoApropriacaoCreditoCombustivel}
     * {@link NFInfoEventoSolicitacaoApropriacaoCreditoCombustivel}
     * {@link NFEventoSolicitacaoApropriacaoCreditoCombustivel}
     *
     * @param detEvento Detalhes específicos do evento.
     * @return Objeto NFEnviaEvento com os dados padrão preenchidos.
     */
    private NFEnviaEventoSolicitacaoApropriacaoCreditoCombustivel gerarDadosPaiXml(NFDetEventoSolicitacaoApropriacaoCreditoCombustivel detEvento) {
        ...
        final NFEventoSolicitacaoApropriacaoCreditoCombustivel evento = new NFEventoSolicitacaoApropriacaoCreditoCombustivel();
        evento.setInfoEvento(infoEvento);
        evento.setVersao(this.getVersaoLayout());

        final NFEnviaEventoSolicitacaoApropriacaoCreditoCombustivel enviaEvento = new NFEnviaEventoSolicitacaoApropriacaoCreditoCombustivel();

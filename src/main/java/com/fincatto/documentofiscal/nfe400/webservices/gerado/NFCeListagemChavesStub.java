...
/*
 * NFCeListagemChavesStub java implementation
 */
public class NFCeListagemChavesStub extends org.apache.axis2.client.Stub {
     ...
     */
    public NFCeListagemChavesStub(final org.apache.axis2.context.ConfigurationContext configurationContext, final java.lang.String targetEndpoint, DFConfig config) throws org.apache.axis2.AxisFault {
     ...
     */
    public NFCeListagemChavesStub(final org.apache.axis2.context.ConfigurationContext configurationContext, final java.lang.String targetEndpoint, final boolean useSeparateListener, DFConfig config) throws org.apache.axis2.AxisFault {
     ...
     */
    public NFCeListagemChavesStub(final java.lang.String targetEndpoint, DFConfig config) throws org.apache.axis2.AxisFault {
        this(null, targetEndpoint, config);
    }

    private static synchronized java.lang.String getUniqueSuffix() {
        // reset the counter if it is greater than 99999
        if (NFCeListagemChavesStub.counter > 99999) {
            NFCeListagemChavesStub.counter = 0;
        }
        NFCeListagemChavesStub.counter = NFCeListagemChavesStub.counter + 1;
        return System.currentTimeMillis() + "_" + NFCeListagemChavesStub.counter;
    }

    private void populateAxisService() {
        // creating the Service with a unique name
        this._service = new org.apache.axis2.description.AxisService("NFCeListagemChaves" + NFCeListagemChavesStub.getUniqueSuffix());
        this.addAnonymousOperations();
        // creating the operations
        org.apache.axis2.description.AxisOperation __operation;
        this._operations = new org.apache.axis2.description.AxisOperation[1];
        __operation = new org.apache.axis2.description.OutInAxisOperation();
        __operation.setName(new javax.xml.namespace.QName("http://www.portalfiscal.inf.br/nfe/wsdl/NFCeListagemChaves", "nfceListagemChaves"));
    ...
    /**
     * Auto generated method signature Servico exclusivo da SEFAZ-SP destinado a obtencao da relacao de chaves das NFC-e recebidas pela Sefaz num determinado periodo
     *
     * @param nfeDadosMsg0
     */
    @SuppressWarnings({"rawtypes", "unchecked"})
    public NfceListagemChavesResult nfceListagemChaves(final NfeDadosMsg nfeDadosMsg0) throws java.rmi.RemoteException {
        ...
        try {
            ...
            _operationClient.getOptions().setAction("http://www.portalfiscal.inf.br/nfe/wsdl/NFCeListagemChaves/nfceListagemChaves");
            ...
            final java.lang.Object object = this.fromOM(_returnEnv.getBody().getFirstElement(), NfceListagemChavesResult.class);
            return (NfceListagemChavesResult) object;
        } catch (final org.apache.axis2.AxisFault f) {
            final org.apache.axiom.om.OMElement faultElt = f.getDetail();
            if (faultElt != null) {
                if (this.faultExceptionNameMap.containsKey(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), "nfceListagemChaves"))) {
                    // make the fault by reflection
                    try {
                        final java.lang.String exceptionClassName = (java.lang.String) this.faultExceptionClassNameMap.get(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), "nfceListagemChaves"));
                        ...
                        // message class
                        final java.lang.String messageClassName = (java.lang.String) this.faultMessageMap.get(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), "nfceListagemChaves"));
    ...
    private java.lang.Object fromOM(final org.apache.axiom.om.OMElement param, final java.lang.Class type) throws org.apache.axis2.AxisFault {
        try {
            if (NfceListagemChavesResult.class.equals(type)) {
                return NfceListagemChavesResult.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }
    ...
    public static class NfeDadosMsg implements org.apache.axis2.databinding.ADBBean {
        public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://www.portalfiscal.inf.br/nfe/wsdl/NFCeListagemChaves", "nfeDadosMsg");
        ...
        public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter, final boolean serializeType) throws javax.xml.stream.XMLStreamException {
            ...
            if (serializeType) {
                final java.lang.String namespacePrefix = this.registerPrefix(xmlWriter, "http://www.portalfiscal.inf.br/nfe/wsdl/NFCeListagemChaves");
        ...
        private static java.lang.String generatePrefix(final java.lang.String namespace) {
            if (namespace.equals("http://www.portalfiscal.inf.br/nfe/wsdl/NFCeListagemChaves")) {
                return "ns1";
            }
    ...
    @SuppressWarnings("serial")
    public static class NfceListagemChavesResult implements org.apache.axis2.databinding.ADBBean {
        public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://www.portalfiscal.inf.br/nfe/wsdl/NFCeListagemChaves", "nfceListagemChavesResult", "ns1");
        ...
        @Override
        public org.apache.axiom.om.OMElement getOMElement(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory) {
            return factory.createOMElement(new org.apache.axis2.databinding.ADBDataSource(this, NfceListagemChavesResult.MY_QNAME));
        }
        ...
        public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter, final boolean serializeType) throws javax.xml.stream.XMLStreamException {
            ...
            if (serializeType) {
                final java.lang.String namespacePrefix = this.registerPrefix(xmlWriter, "http://www.portalfiscal.inf.br/nfe/wsdl/NFCeListagemChaves");
                if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                    this.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":nfceListagemChavesResult", xmlWriter);
                } else {
                    this.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "nfceListagemChavesResult", xmlWriter);
                }
            }
            if (this.localExtraElement != null) {
                this.localExtraElement.serialize(xmlWriter);
        ...
        private void writeStartElement(java.lang.String prefix, final java.lang.String namespace, final java.lang.String localPart, final javax.xml.stream.XMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
            ...
            if (writerPrefix != null) {
                ...
                if (namespace.length() == 0) {
                    ...
                    prefix = NfceListagemChavesResult.generatePrefix(namespace);
                }
                xmlWriter.writeStartElement(prefix, localPart, namespace);
                xmlWriter.writeNamespace(prefix, namespace);
                xmlWriter.setPrefix(prefix, namespace);
        ...
        public static class Factory {
            ...
            @SuppressWarnings({"unused", "rawtypes"})
            public static NfceListagemChavesResult parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
                final NfceListagemChavesResult object = new NfceListagemChavesResult();
                final int event;
                javax.xml.namespace.QName currentQName = null;
                final java.lang.String nillableValue = null;
                final java.lang.String prefix = "";
                ...
                try {
                    ...
                    if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                        ...
                        if (fullTypeName != null) {
                            ...
                            nsPrefix = (nsPrefix == null) ? "" : nsPrefix;
                            final java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":") + 1);
                            if (!"nfceListagemChavesResult".equals(type)) {
                                final java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (NfceListagemChavesResult) ExtensionMapper.getTypeObject(nsUri, type, reader);
                            }
                        }
                    }
                    final java.util.Vector handledAttributes = new java.util.Vector();

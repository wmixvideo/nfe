...
public class WSFacade {
     ...
     * @throws Exception caso nao consiga gerar o xml ou problema de conexao com sefaz
     */
     ...
     * Pode ser feita pela chave de acesso ou utilizando o NSU (numero sequencial unico) da receita.
     *
     ...
     * @param chaveAcesso
     * @param nsu Número Sequencial Único. Geralmente esta consulta sera utilizada quando identificado pelo interessado um NSU faltante. O Web Service retornará o documento ou informará que o NSU não existe no Ambiente Nacional. Assim, esta consulta fechará a lacuna do NSU identificado como faltante.

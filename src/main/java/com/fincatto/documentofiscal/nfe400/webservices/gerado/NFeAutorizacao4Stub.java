...
public class NFeAutorizacao4Stub extends org.apache.axis2.client.Stub {
     ...
     * @see com.fincatto.documentofiscal.nfe400.webservices.gerado.NFeAutorizacao4#startnfeAutorizacaoLote
     * @param nfeDadosMsg1
     */
    @SuppressWarnings({ "rawtypes", "unchecked" })
    public void startnfeAutorizacaoLote(final NfeDadosMsg nfeDadosMsg1, final NFeAutorizacao4CallbackHandler callback) throws java.rmi.RemoteException {
        final org.apache.axis2.client.OperationClient _operationClient = this._serviceClient.createClient(this._operations[0].getName());
        _operationClient.getOptions().setAction("http://www.portalfiscal.inf.br/nfe/wsdl/NFeAutorizacao4/nfeAutorizacaoLote");
        _operationClient.getOptions().setExceptionToBeThrownOnSOAPFault(true);
        ...
        _operationClient.setCallback(new org.apache.axis2.client.async.AxisCallback() {
            ...
            public void onMessage(final org.apache.axis2.context.MessageContext resultContext) {
                try {
                    ...
                    final java.lang.Object object = NFeAutorizacao4Stub.this.fromOM(resultEnv.getBody().getFirstElement(), NfeResultMsg.class);
                    callback.receiveResultnfeAutorizacaoLote((NfeResultMsg) object);
            ...
            public void onError(final java.lang.Exception error) {
                if (error instanceof org.apache.axis2.AxisFault) {
                    ...
                    if (faultElt != null) {
                        if (NFeAutorizacao4Stub.this.faultExceptionNameMap.containsKey(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), "nfeAutorizacaoLote"))) {
                            // make the fault by reflection
                            try {
                                final java.lang.String exceptionClassName = (java.lang.String) NFeAutorizacao4Stub.this.faultExceptionClassNameMap.get(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), "nfeAutorizacaoLote"));
                                final java.lang.Class exceptionClass = java.lang.Class.forName(exceptionClassName);
                                final java.lang.reflect.Constructor constructor = exceptionClass.getConstructor(java.lang.String.class);
                                final java.lang.Exception ex = (java.lang.Exception) constructor.newInstance(f.getMessage());

                                // message class
                                final java.lang.String messageClassName = (java.lang.String) NFeAutorizacao4Stub.this.faultMessageMap.get(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), "nfeAutorizacaoLote"));
                                final java.lang.Class messageClass = java.lang.Class.forName(messageClassName);
                                final java.lang.Object messageObject = NFeAutorizacao4Stub.this.fromOM(faultElt, messageClass);
                                final java.lang.reflect.Method m = exceptionClass.getMethod("setFaultMessage", new java.lang.Class[] { messageClass });
                                m.invoke(ex, new java.lang.Object[] { messageObject });
    ...
    /**
     * Auto generated method signature
     * @see com.fincatto.documentofiscal.nfe400.webservices.gerado.NFeAutorizacao4#nfeAutorizacaoLoteZip
    ...
    /**
     * Auto generated method signature for Asynchronous Invocations
     * @see com.fincatto.documentofiscal.nfe400.webservices.gerado.NFeAutorizacao4#startnfeAutorizacaoLoteZip
     * @param nfeDadosMsgZip3
     */
    @SuppressWarnings({ "rawtypes", "unchecked" })
    public void startnfeAutorizacaoLoteZip(final NfeDadosMsgZip nfeDadosMsgZip3, final NFeAutorizacao4CallbackHandler callback) throws java.rmi.RemoteException {
        final org.apache.axis2.client.OperationClient _operationClient = this._serviceClient.createClient(this._operations[1].getName());
        _operationClient.getOptions().setAction("http://www.portalfiscal.inf.br/nfe/wsdl/NFeAutorizacao4/nfeAutorizacaoLoteZip");
        _operationClient.getOptions().setExceptionToBeThrownOnSOAPFault(true);
        ...
        _operationClient.setCallback(new org.apache.axis2.client.async.AxisCallback() {
            ...
            public void onMessage(final org.apache.axis2.context.MessageContext resultContext) {
                try {
                    ...
                    final java.lang.Object object = NFeAutorizacao4Stub.this.fromOM(resultEnv.getBody().getFirstElement(), NfeResultMsg.class);
                    callback.receiveResultnfeAutorizacaoLoteZip((NfeResultMsg) object);
                } catch (final org.apache.axis2.AxisFault e) {
            ...
            public void onError(final java.lang.Exception error) {
                if (error instanceof org.apache.axis2.AxisFault) {
                    ...
                    if (faultElt != null) {
                        if (NFeAutorizacao4Stub.this.faultExceptionNameMap.containsKey(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), "nfeAutorizacaoLoteZip"))) {
                            // make the fault by reflection
                            try {
                                final java.lang.String exceptionClassName = (java.lang.String) NFeAutorizacao4Stub.this.faultExceptionClassNameMap.get(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), "nfeAutorizacaoLoteZip"));
                                final java.lang.Class exceptionClass = java.lang.Class.forName(exceptionClassName);
                                final java.lang.reflect.Constructor constructor = exceptionClass.getConstructor(java.lang.String.class);
                                final java.lang.Exception ex = (java.lang.Exception) constructor.newInstance(f.getMessage());

                                // message class
                                final java.lang.String messageClassName = (java.lang.String) NFeAutorizacao4Stub.this.faultMessageMap.get(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), "nfeAutorizacaoLoteZip"));
                                final java.lang.Class messageClass = java.lang.Class.forName(messageClassName);
                                final java.lang.Object messageObject = NFeAutorizacao4Stub.this.fromOM(faultElt, messageClass);
                                final java.lang.reflect.Method m = exceptionClass.getMethod("setFaultMessage", new java.lang.Class[] { messageClass });
                                m.invoke(ex, new java.lang.Object[] { messageObject });
    ...
    abstract class NFeAutorizacao4CallbackHandler {
         ...
         */
        public NFeAutorizacao4CallbackHandler(final Object clientData) {
        ...
        /**
         * auto generated Axis2 call back method for nfeAutorizacaoLote method override this method for handling normal response from nfeAutorizacaoLote operation
         */
        public void receiveResultnfeAutorizacaoLote(final NfeResultMsg result) {
        }

        /**
         * auto generated Axis2 Error handler override this method for handling error response from nfeAutorizacaoLote operation
         */
        public void receiveErrornfeAutorizacaoLote(final java.lang.Exception e) {
        }

        /**
         * auto generated Axis2 call back method for nfeAutorizacaoLoteZip method override this method for handling normal response from nfeAutorizacaoLoteZip operation
         */
        public void receiveResultnfeAutorizacaoLoteZip(final NfeResultMsg result) {
        }

        /**
         * auto generated Axis2 Error handler override this method for handling error response from nfeAutorizacaoLoteZip operation
         */
        public void receiveErrornfeAutorizacaoLoteZip(final java.lang.Exception e) {
        }
    }

...
public enum DFUnidadeFederativa {
    ...
    RN("RN", "Rio Grande do Norte", "24", "http://hom.nfce.set.rn.gov.br/consultarNFCe.aspx", "http://nfce.set.rn.gov.br/consultarNFCe.aspx", "www.set.rn.gov.br/nfce/consulta", "www.set.rn.gov.br/nfce/consulta"),

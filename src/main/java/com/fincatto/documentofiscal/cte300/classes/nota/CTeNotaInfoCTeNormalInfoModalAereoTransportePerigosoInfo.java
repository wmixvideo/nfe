...
public class CTeNotaInfoCTeNormalInfoModalAereoTransportePerigosoInfo extends DFBase {
	 ...
	 * Deve indicar a quantidade total do artigo perigoso, tendo como base a unidade referenciada na Tabela 3-1 do Doc 9284, por exemplo: litros; quilogramas; 
	 * quilograma bruto etc. O preenchimento não deve, entretanto, incluir a unidade de medida. No caso de transporte de material radioativo, deve-se indicar o 
	 * somatório dos Índices de Transporte (TI). Não indicar a quantidade do artigo perigoso por embalagem.
	 * */
	 ...
	 * 5- Unidades (apenas para artigos perigosos medidos em unidades que não se enquadram nos itens acima. Exemplo: baterias, celulares, equipamentos, veículos, 
	 * dentre outros)
	 * */
	public void setUnidade(CTUnidadeMedidaProdPerigosos unidade) {

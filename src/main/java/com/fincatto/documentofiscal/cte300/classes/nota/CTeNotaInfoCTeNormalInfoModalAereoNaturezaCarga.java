...
public class CTeNotaInfoCTeNormalInfoModalAereoNaturezaCarga extends DFBase {
	...
	/**
	 * Dimensão<br>
	 * Formato:1234X1234X1234 (cm). Esse campo deve sempre que possível ser preenchido. Entretanto, quando for impossível o preenchimento das dimensões, 
	 * fica obrigatório o preenchimento da cubagem em metro cúbico do leiaute do CT-e da estrutura genérica (infQ).
	 * */
	 ...
	 * */
	public void setInformacoesManuseio(List<CTInformacoesManuseio> informacoesManuseio) {

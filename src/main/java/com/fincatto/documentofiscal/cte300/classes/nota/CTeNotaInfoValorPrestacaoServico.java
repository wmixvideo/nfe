...
public class CTeNotaInfoValorPrestacaoServico extends CTBase {
	...
	public List<CTeNotaInfoValorPrestacaoServicoComponentesValorPrestacao> getComponentesValorPrestacao() {
		return componentesValorPrestacao;
	}

	/**
	 * Componentes do Valor da Prestação
	 * */
	public void setComponentesValorPrestacao(
			List<CTeNotaInfoValorPrestacaoServicoComponentesValorPrestacao> componentesValorPrestacao) {

...
public class CTeNotaInfoCTeNormalInfoCarga extends DFBase {
	...
	public String getDescricaoProdutoPredominante() {
		return descricaoProdutoPredominante;
	}
	...
	public String getDescricaoOutrasCaracteristicas() {
		return descricaoOutrasCaracteristicas;
	}
	 ...
	 * 4 - Cubagem, sempre em metros cúbicos (obrigatório apenas quando for impossível preencher as dimensões da(s) embalagem(ens) 
	 * na tag xDime do leiaute do Aéreo).
	 * */
	 ...
	 * Normalmente igual ao valor declarado da mercadoria, diferente por exemplo, quando a mercadoria transportada é isenta de tributos nacionais para exportação, 
	 * onde é preciso averbar um valor maior, pois no caso de indenização, o valor a ser pago será maior
	 * */

...
/**
 * This object contains factory methods for each Java content interface and Java element interface generated in the br.inf.portalfiscal.nfe.wsdl.nferecepcao2 package.
 * <p>
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: br.inf.portalfiscal.nfe.wsdl.nferecepcao2
     */
    ...
    public JAXBElement<NfeCabecMsg> createNfeCabecMsg(final NfeCabecMsg value) {
        return new JAXBElement<NfeCabecMsg>(ObjectFactory._NfeCabecMsg_QNAME, NfeCabecMsg.class, null, value);
    }

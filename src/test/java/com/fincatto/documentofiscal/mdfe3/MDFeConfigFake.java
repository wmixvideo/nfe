...
public class MDFeConfigFake extends MDFeConfig implements DFLog {
    ...
    public KeyStore getCertificadoKeyStore() throws KeyStoreException {
        if (this.keyStoreCertificado == null) {
            ...
            try (InputStream certificadoStream = MDFeConfigFake.class.getResourceAsStream("homologacao.pfx")) {
    ...
    public KeyStore getCadeiaCertificadosKeyStore() throws KeyStoreException {
        if (this.keyStoreCadeia == null) {
            ...
            try (InputStream cadeia = MDFeConfigFake.class.getResourceAsStream("homologacao.cacerts")) {

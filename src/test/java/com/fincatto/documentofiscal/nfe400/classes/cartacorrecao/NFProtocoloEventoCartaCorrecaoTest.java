...
public class NFProtocoloEventoCartaCorrecaoTest {
    ...
    public void deveObterEventoComoFoiSetado() {
        ...
        Assertions.assertEquals(FabricaDeObjetosFake.getNFEventoCartaCorrecao().getVersao(), procEvento.getEvento().getVersao());
    }
    ...
    public void deveObterEventoRetornoComoFoiSetado() {
        ...
        Assertions.assertEquals(eventoRet.getVersao(), procEvento.getEventoRetorno().getVersao());
    }

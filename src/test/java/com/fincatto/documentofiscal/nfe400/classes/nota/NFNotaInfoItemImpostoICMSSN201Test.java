...
public class NFNotaInfoItemImpostoICMSSN201Test {
    ...
    public void naoDevePermitirValorZeradoParaPercentualFundoCombatePobreza() {
        Assertions.assertThrows(IllegalStateException.class, () -> new NFNotaInfoItemImpostoICMSSN201().setPercentualFundoCombatePobrezaST(BigDecimal.ZERO));
    }
    ...
    public void naoDevePermitirModalidadeDeterminacaoBCICMSSTNulo() {
        Assertions.assertThrows(IllegalStateException.class, () -> {
            ...
            icms201.setSituacaoOperacaoSN(NFNotaSituacaoOperacionalSimplesNacional.CSOSN_300);

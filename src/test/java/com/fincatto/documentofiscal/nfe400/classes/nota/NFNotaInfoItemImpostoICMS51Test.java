...
public class NFNotaInfoItemImpostoICMS51Test {
	...
	public void naoDevePermitirPercentualICMSComTamanhoDiferente() {
		Assertions.assertThrows(NumberFormatException.class, () -> new NFNotaInfoItemImpostoICMS51().setPercentualICMS(new BigDecimal("10000")));
	}

	@Test
	public void naoDevePermitirPercentualReducaoBCComTamanhoDiferente() {
		Assertions.assertThrows(NumberFormatException.class, () -> new NFNotaInfoItemImpostoICMS51().setPercentualReducaoBC(new BigDecimal("1000")));
	}

	@Test
	public void naoDevePermitirValorBCICMSComTamanhoDiferente() {
		Assertions.assertThrows(NumberFormatException.class, () -> new NFNotaInfoItemImpostoICMS51().setValorBCICMS(new BigDecimal("10000000000000")));
	}

	@Test
	public void naoDevePermitirValorICMSComTamanhoDiferente() {
		Assertions.assertThrows(NumberFormatException.class, () -> new NFNotaInfoItemImpostoICMS51().setValorICMS(new BigDecimal("10000000000000")));
	}
	...
	public void deveGerarXMLDeAcordoComOPadraoEstabelecido() {
		...
		Assertions.assertEquals(xmlEsperado, icms51.toString());
	}
}
...
public class NFEnviaEventoTest {
    ...
    public void naoDevePermitirIdLoteComTamanhoInvalido() {
        Assertions.assertThrows(IllegalStateException.class, () -> new NFEnviaEventoCartaCorrecao().setIdLote("9999999999999999"));
    }
    ...
    public void deveGerarXMLDeAcordoComOPadraoEstabelecido() {
        ...
        Assertions.assertEquals(xmlEsperado, enviaEvento.toString());
    }
}
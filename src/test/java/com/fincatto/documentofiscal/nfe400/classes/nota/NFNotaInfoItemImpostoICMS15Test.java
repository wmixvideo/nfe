...
public class NFNotaInfoItemImpostoICMS15Test {
    ...
    public void naoDevePermitirPercentualAliquotaComTamanhoInvalido() {
        Assertions.assertThrows(NumberFormatException.class, () -> new NFNotaInfoItemImpostoICMS15().setPercentualAliquota(new BigDecimal("1000")));
    }

    @Test
    public void naoDevePermitirValorBaseCalculoComTamanhoInvalido() {
        Assertions.assertThrows(NumberFormatException.class, () -> new NFNotaInfoItemImpostoICMS15().setQuantidadeBaseCalculo(new BigDecimal("10000000000000")));
    }

    @Test
    public void naoDevePermitirValorTributoComTamanhoInvalido() {
        Assertions.assertThrows(NumberFormatException.class, () -> new NFNotaInfoItemImpostoICMS15().setValorTributo(new BigDecimal("10000000000000")));
    }

    @Test
    public void naoDevePermitirPercentualAliquotaRetencaoComTamanhoInvalido() {
        Assertions.assertThrows(NumberFormatException.class, () -> new NFNotaInfoItemImpostoICMS15().setPercentualAliquotaRetencao(new BigDecimal("1000")));
    }

    @Test
    public void naoDevePermitirValorBaseCalculoRetencaoComTamanhoInvalido() {
        Assertions.assertThrows(NumberFormatException.class, () -> new NFNotaInfoItemImpostoICMS15().setQuantidadeBaseCalculoTributadaSujeitaRetencao(new BigDecimal("10000000000000")));
    }

    @Test
    public void naoDevePermitirValorTributoRetencaoComTamanhoInvalido() {
        Assertions.assertThrows(NumberFormatException.class, () -> new NFNotaInfoItemImpostoICMS15().setValorTributoRetencao(new BigDecimal("10000000000000")));
    }
    ...
    public void deveGerarXMLDeAcordoComOPadraoEstabelecido() {
        ...
        Assertions.assertEquals(xmlEsperado, FabricaDeObjetosFake.getNFNotaInfoItemImpostoICMS15().toString());
    }
}
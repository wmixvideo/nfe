...
public class NFRetornoConsultaCadastroEnderecoTest {
    ...
    public void deveObterBairroComoFoiSetado() {
        ...
        Assertions.assertEquals("Jardim America", retornoConsultaCadastroEndereco.getBairro());
    }
    ...
    public void deveObterCepComoFoiSetado() {
        ...
        Assertions.assertEquals("88132-020", retornoConsultaCadastroEndereco.getCep());
    }
    ...
    public void deveObterCodigoMunicipioFoiSetado() {
        ...
        Assertions.assertEquals("3456", retornoConsultaCadastroEndereco.getCodigoMunicipio());
    }
    ...
    public void deveObterComplementoComoFoiSetado() {
        ...
        Assertions.assertEquals("Em cima da mercearia nego drama", retornoConsultaCadastroEndereco.getComplemento());
    }
    ...
    public void deveObterConsultaCadastroComoFoiSetado() {
        ...
        Assertions.assertEquals("Palho\u00e7a", retornoConsultaCadastroEndereco.getDescricaoMunicipio());
    }
    ...
    public void deveObterLogradouroComoFoiSetado() {
        ...
        Assertions.assertEquals("Av Jos\u00e9 Bonif\u00e1cio", retornoConsultaCadastroEndereco.getLogradouro());
    }
    ...
    public void deveObterNumeroComoFoiSetado() {
        ...
        Assertions.assertEquals("1435", retornoConsultaCadastroEndereco.getNumero());
    }
}
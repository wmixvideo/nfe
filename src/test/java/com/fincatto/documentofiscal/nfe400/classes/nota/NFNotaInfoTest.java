...
public class NFNotaInfoTest {
    ...
    public void deveObterIdentificadorComPrefixo() {
        ...
        Assertions.assertEquals("NFe" + identificador, notaInfo.getIdentificador());
    }
    ...
    public void deveObterIdentificacaoComoFoiSetado() {
        ...
        Assertions.assertEquals(identificacao, notaInfo.getIdentificacao());
    }
    ...
    public void deveObterVersaoComoFoiSetado() {
        ...
        Assertions.assertEquals("3.10", notaInfo.getVersao());
    }
    ...
    public void deveObterEmitenteComoFoiSetado() {
        ...
        Assertions.assertEquals(emitente, notaInfo.getEmitente());
    }
    ...
    public void deveObterAvulsaComoFoiSetado() {
        ...
        Assertions.assertEquals(avulsa, notaInfo.getAvulsa());
    }
    ...
    public void deveObterDestinatarioComoFoiSetado() {
        ...
        Assertions.assertEquals(destinatario, notaInfo.getDestinatario());
    }
    ...
    public void deveObterRetiradaComoFoiSetado() {
        ...
        Assertions.assertEquals(retirada, notaInfo.getRetirada());
    }
    ...
    public void deveObterEntregaComoFoiSetado() {
        ...
        Assertions.assertEquals(entrega, notaInfo.getEntrega());
    }
    ...
    public void deveObterPessoasAutorizadasDownloadNFeComoFoiSetado() {
        ...
        Assertions.assertEquals(pessoasAutorizadasDownloadNFe, notaInfo.getPessoasAutorizadasDownloadNFe());
    }
    ...
    public void deveObterItensComoFoiSetado() {
        ...
        Assertions.assertEquals(itens, notaInfo.getItens());
    }
    ...
    public void deveObterTotalComoFoiSetado() {
        ...
        Assertions.assertEquals(total, notaInfo.getTotal());
    }
    ...
    public void deveObterTransporteComoFoiSetado() {
        ...
        Assertions.assertEquals(transporte, notaInfo.getTransporte());
    }
    ...
    public void deveObterCobrancaComoFoiSetado() {
        ...
        Assertions.assertEquals(cobranca, notaInfo.getCobranca());
    }
    ...
    public void deveObterPagamentosComoFoiSetado() {
        ...
        Assertions.assertEquals(pagamento, notaInfo.getPagamento());
    }
    ...
    public void deveObterInformacoesAdicionaisComoFoiSetado() {
        ...
        Assertions.assertEquals(informacoesAdicionais, notaInfo.getInformacoesAdicionais());
    }
    ...
    public void deveObterExportacaoComoFoiSetado() {
        ...
        Assertions.assertEquals(exportacao, notaInfo.getExportacao());
    }
    ...
    public void deveObterCompraComoFoiSetado() {
        ...
        Assertions.assertEquals(compra, notaInfo.getCompra());
    }
    ...
    public void deveObterCanaComoFoiSetado() {
        ...
        Assertions.assertEquals(cana, notaInfo.getCana());
    }
    ...
    public void naoDevePermitirVersaoComTamanhoInvalido() {
        Assertions.assertThrows(NumberFormatException.class, () -> new NFNotaInfo().setVersao(new BigDecimal("100")));
    }
    ...
    public void deveGerarXMLDeAcordoComOPadraoEstabelecido() {
		...
		Assertions.assertEquals(xmlEsperado, FabricaDeObjetosFake.getNFNotaInfoIntermediador().toString());
        ...
        Assertions.assertEquals(xmlEsperadoII, nfNotaInfoIntermediador.toString());

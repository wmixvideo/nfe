...
public class NFViaTransporteInternacionalTest {
    ...
    public void deveRepresentarOCodigoCorretamente() {
        ...
        Assertions.assertEquals("12", NFViaTransporteInternacional.EM_MAOS.getCodigo());
    }
    ...
    public void deveObterEnumPeloCodigo() {
        ...
        Assertions.assertEquals(NFViaTransporteInternacional.EM_MAOS, NFViaTransporteInternacional.valueOfCodigo("12"));
    }
}
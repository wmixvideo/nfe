...
public class NFCeListagemChavesTest {
    ...
    public void deveObterVersaoComoFoiSetado() {
        ...
        Assertions.assertEquals("1.00", listagemChaves.getVersao());
    }
    ...
    public void deveObterAmbienteComoFoiSetado() {
        ...
        Assertions.assertEquals(DFAmbiente.HOMOLOGACAO, listagemChaves.getAmbiente());
    }
    ...
    public void deveFormatarDataHoraInicialSemSegundos() {
        ...
        Assertions.assertEquals("2026-07-21T15:30", listagemChaves.getDataHoraInicial());
    }
    ...
    public void deveFormatarDataHoraFinalSemSegundos() {
        ...
        Assertions.assertEquals("2026-07-21T23:59", listagemChaves.getDataHoraFinal());
    }
    ...
    public void devePermitirDataHoraFinalNula() {
        ...
        Assertions.assertNull(listagemChaves.getDataHoraFinal());
    }
}

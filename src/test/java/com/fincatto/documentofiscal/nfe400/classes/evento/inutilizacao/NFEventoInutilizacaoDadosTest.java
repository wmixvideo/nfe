...
public class NFEventoInutilizacaoDadosTest {
    ...
    public void naoDevePermitirModeloInvalido() {
        Assertions.assertThrows(IllegalStateException.class, () -> dados.setModeloDocumentoFiscal("75"));
    }
    ...
    public void naoDevePermitirCNPJInvalido() {
        Assertions.assertThrows(IllegalStateException.class, () -> dados.setCnpj("1234567890123"));
    }
    ...
    public void naoDevePermitirServicoInvalido() {
        Assertions.assertThrows(IllegalStateException.class, () -> dados.setNomeServico("inutiliza"));
    }

    @Test
    public void naoDevePermitirIDInvalido() {
        Assertions.assertThrows(IllegalStateException.class, () -> dados.setIdentificador("IDw6cRIPJzP4sv6gBWQFCNcFSITQK7rOxjmBFcW2Mzf"));
    }

...
public class NFNotaInfoISSQNTotalTest {
    ...
    public void naoDevePermitirValorTotalServicosSobNaoIncidenciaNaoTributadosICMSComValorInvalido() {
        Assertions.assertThrows(NumberFormatException.class, () -> new NFNotaInfoISSQNTotal().setValorTotalServicosSobNaoIncidenciaNaoTributadosICMS(new BigDecimal("1000000000000000")));
    }

    @Test
    public void naoDevePermitirValorTotalISSComValorInvalido() {
        Assertions.assertThrows(NumberFormatException.class, () -> new NFNotaInfoISSQNTotal().setValorTotalISS(new BigDecimal("1000000000000000")));
    }

    @Test
    public void naoDevePermitirValorPISsobreServicosInvalido() {
        Assertions.assertThrows(NumberFormatException.class, () -> new NFNotaInfoISSQNTotal().setValorPISsobreServicos(new BigDecimal("1000000000000000")));
    }

    @Test
    public void naoDevePermitirValorCOFINSsobreServicosInvalido() {
        Assertions.assertThrows(NumberFormatException.class, () -> new NFNotaInfoISSQNTotal().setValorCOFINSsobreServicos(new BigDecimal("1000000000000000")));
    }
    ...
    public void deveGerarXMLDeAcordoComOPadraoEstabelecidoComVagao() {
        ...
        Assertions.assertEquals(xmlEsperado, FabricaDeObjetosFake.getNFNotaInfoISSQNTotal().toString());
    }
}
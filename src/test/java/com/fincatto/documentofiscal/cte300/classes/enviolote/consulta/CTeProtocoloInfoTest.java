...
public class CTeProtocoloInfoTest {
    ...
    public void deveObterVersaoAplicacaoComoFoiSetado() {
        final CTeProtocoloInfo info = new CTeProtocoloInfo();
        info.setVersaoAplicacao("3.00");
        Assert.assertEquals("3.00", info.getVersaoAplicacao());
    }
    ...
    public void deveObterNumeroProtocoloComoFoiSetado() {
        final CTeProtocoloInfo info = new CTeProtocoloInfo();
        info.setNumeroProtocolo("315200000012345");
        Assert.assertEquals("315200000012345", info.getNumeroProtocolo());
    }
    ...
    public void deveGerarXMLComChaveQuandoChaveEstiverPresente() {
        ...
        Assert.assertTrue("XML deve conter <verAplic>", xml.contains("<verAplic>3.00</verAplic>"));
    ...
    public void deveDesserializarXMLComChavePresente() throws Exception {
        ...
        Assert.assertEquals("3.00", result.getVersaoAplicacao());
        ...
        Assert.assertEquals("315200000012345", result.getNumeroProtocolo());

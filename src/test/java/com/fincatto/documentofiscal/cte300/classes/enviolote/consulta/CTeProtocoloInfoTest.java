...
public class CTeProtocoloInfoTest {
    ...
    public void deveObterVersaoAplicacaoComoFoiSetado() {
        ...
        Assertions.assertEquals("3.00", info.getVersaoAplicacao());
    }
    ...
    public void deveObterNumeroProtocoloComoFoiSetado() {
        ...
        Assertions.assertEquals("315200000012345", info.getNumeroProtocolo());
    }
    ...
    public void deveGerarXMLComChaveQuandoChaveEstiverPresente() {
        ...
        Assertions.assertTrue(xml.contains("<verAplic>3.00</verAplic>"));
    ...
    public void deveDesserializarXMLComChavePresente() throws Exception {
        ...
        Assertions.assertEquals("3.00", result.getVersaoAplicacao());
        ...
        Assertions.assertEquals("315200000012345", result.getNumeroProtocolo());

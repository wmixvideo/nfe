...
public class CTeNotaInfoTest {
    ...
    public void deveAceitarIdentificadorNumerico() {
        ...
        Assert.assertEquals("CTe12345678901234567890123456789012345678901234", info.getIdentificador());
    }
    ...
    public void deveAceitarIdentificadorAlfanumerico() {
        ...
        Assert.assertEquals("CTe1234567890123456789012345678901234567890123A", info.getIdentificador());
    }
    ...
    public void deveAceitarIdentificadorComLetras() {
        ...
        Assert.assertEquals("CTeABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789ABCDEFGH", info.getIdentificador());
    }
    ...
    public void deveRetornarChaveAcessoComRemoçãoPrefixo() {
        final CTeNotaInfo info = new CTeNotaInfo();
        info.setIdentificador("12345678901234567890123456789012345678901234");
        Assert.assertEquals("12345678901234567890123456789012345678901234", info.getChaveAcesso());
    }

    @Test
    public void deveValidarTamanhoPrefixo() {
        final CTeNotaInfo info = new CTeNotaInfo();
        Assert.assertEquals("CTe", CTeNotaInfo.IDENT);
    }

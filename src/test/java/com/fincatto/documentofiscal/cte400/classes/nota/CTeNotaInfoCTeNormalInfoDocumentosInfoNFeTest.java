...
public class CTeNotaInfoCTeNormalInfoDocumentosInfoNFeTest {
    ...
    public void devePermitirChaveNFeAlfanumerica() {
        ...
        Assertions.assertEquals(chaveAlfanumerica, infoNFe.getChave());
    }

    @Test
    public void naoDevePermitirChaveNFeMenorQue44Caracteres() {
        Assertions.assertThrows(IllegalStateException.class, () -> new CTeNotaInfoCTeNormalInfoDocumentosInfoNFe().setChave("422505AB0000000000015500100000000110000000"));
    }

    @Test
    public void naoDevePermitirChaveNFeMaiorQue44Caracteres() {
        Assertions.assertThrows(IllegalStateException.class, () -> new CTeNotaInfoCTeNormalInfoDocumentosInfoNFe().setChave("422505AB0000000000015500100000000110000000100"));
    }
}

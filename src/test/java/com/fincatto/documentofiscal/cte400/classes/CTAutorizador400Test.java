...
public class CTAutorizador400Test {
    ...
    public void deveBuscarCorretamenteURLsWebServiceMT() {
		...
		Assert.assertNull(autorizador.getCteRecepcaoSinc(DFAmbiente.PRODUCAO));
		Assert.assertNull(autorizador.getCteRecepcaoOS(DFAmbiente.PRODUCAO));
		Assert.assertNull(autorizador.getCteRecepcaoGTVe(DFAmbiente.PRODUCAO));
		Assert.assertNull(autorizador.getCteConsultaProtocolo(DFAmbiente.PRODUCAO));
		Assert.assertNull(autorizador.getCteStatusServico(DFAmbiente.PRODUCAO));

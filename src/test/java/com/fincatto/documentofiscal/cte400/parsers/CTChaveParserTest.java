...
public class CTChaveParserTest {
    ...
    public void naoDevePermitirChaveNula() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> new CTChaveParser(null));
    }

    @Test
    public void naoDevePermitirChaveDeTamanhoMenor() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> new CTChaveParser("3526050X0J92JY00019657001000000604144867901"));
    }

    @Test
    public void naoDevePermitirChaveDeTamanhoMaior() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> new CTChaveParser("3526050X0J92JY000196570010000006041448679011999"));
    }
    ...
    public void deveUniformizarParaMAIUSCULAS() {
        final CTChaveParser parser = new CTChaveParser("3526050x0j92jy000196570010000006041448679011");
        Assertions.assertEquals("3526050X0J92JY000196570010000006041448679011", parser.getChave());
    }
    ...
    public void deveObterUFDeChave() {
        final CTChaveParser parser = new CTChaveParser("3526050X0J92JY000196570010000006041448679011");
        Assertions.assertEquals(DFUnidadeFederativa.SP, parser.getNFUnidadeFederativa());
    }
    ...
    public void deveObterDataDeEmissaoDaChave() {
        final CTChaveParser parser = new CTChaveParser("3526050X0J92JY000196570010000006041448679011");
        Assertions.assertEquals(LocalDate.of(2026, 5, 1), parser.getDataEmissao());
    }

    @Test
    public void deveObterSerieDaChave() {
        final CTChaveParser parser = new CTChaveParser("3526050X0J92JY000196570010000006041448679011");
        Assertions.assertEquals("001", parser.getSerie());
    }

    @Test
    public void deveObterNumeroDaChave() {
        final CTChaveParser parser = new CTChaveParser("3526050X0J92JY000196570010000006041448679011");
        Assertions.assertEquals("000000604", parser.getNumero());
    }

    @Test
    public void deveObterCnpjEmitenteDaChave() {
        final CTChaveParser parser = new CTChaveParser("3526050X0J92JY000196570010000006041448679011");
        Assertions.assertEquals("0X0J92JY000196", parser.getCnpjEmitente());
    }

    @Test
    public void deveObterCnpjEmitenteDeChavedeSomenteNumeros() {
        final CTChaveParser parser = new CTChaveParser("35260502605000000019657001000000604144867901");
        Assertions.assertEquals("02605000000019", parser.getCnpjEmitente());
    }

    @Test
    public void deveObterModeloDaChave() {
        final CTChaveParser parser = new CTChaveParser("3526050X0J92JY000196570010000006041448679011");
        Assertions.assertEquals(DFModelo.CTE, parser.getModelo());
    }

    @Test
    public void deveObterFormaEmissaoDaChave() {
        final CTChaveParser parser = new CTChaveParser("3526050X0J92JY000196570010000006041448679011");
        Assertions.assertEquals(CTTipoEmissao.EMISSAO_NORMAL, parser.getFormaEmissao());
    }

    @Test
    public void deveObterCodigoNumericoDaChave() {
        final CTChaveParser parser = new CTChaveParser("3526050X0J92JY000196570010000006041448679011");
        Assertions.assertEquals("44867901", parser.getCodigoNumerico());
    }

    @Test
    public void deveObterDVDaChave() {
        final CTChaveParser parser = new CTChaveParser("3526050X0J92JY000196570010000006041448679011");
        Assertions.assertEquals("1", parser.getDV());
    }

    @Test
    public void deveFormatarChaveAlfanumerica() {
        final CTChaveParser parser = new CTChaveParser("3526050X0J92JY000196570010000006041448679011");
        Assertions.assertEquals("3526 050X 0J92 JY00 0196 5700 1000 0006 0414 4867 9011", parser.getFormatado());
    }

    @Test
    public void deveFormatarChaveNumerica() {
        final CTChaveParser parser = new CTChaveParser("35260502605000000019657001000000604144867901");
        Assertions.assertEquals("3526 0502 6050 0000 0019 6570 0100 0000 6041 4486 7901", parser.getFormatado());
    }

    @Test
    public void naoDeveSerEmitidaContingenciaSCVSP() {
        final CTChaveParser parser = new CTChaveParser("3526050X0J92JY000196570010000006041448679011");
        Assertions.assertFalse(parser.isEmitidaContingenciaSCVSP());
    }
    ...
    public void deveSerEmitidaContingenciaSCVSP() {
        ...
        Assertions.assertTrue(parser.isEmitidaContingenciaSCVSP());
    }
    ...
    public void deveRetornarChaevFormatada() {
        final CTChaveParser parser = new CTChaveParser("3526050X0J92JY000196570010000006041448679011");
        Assertions.assertNotNull(parser.getFormatado());
        Assertions.assertTrue(parser.getFormatado().contains(" "));
    }
    ...
    public void deveExtrairCnpjAlfanumerico0JRXDN7G000175() {
        ...
        Assertions.assertEquals("00JRXDN7G00175", parser.getCnpjEmitente());
    }
    ...
    public void deveValidarChaveComCnpjAlfanumericoDiversos() {
        ...
        Assertions.assertEquals("00JRXDN7G00175", parser1.getCnpjEmitente());
        ...
        Assertions.assertEquals("ABCD1234567890", parser2.getCnpjEmitente());
        ...
        Assertions.assertEquals("123456ABCDEF01", parser3.getCnpjEmitente());
    }
    ...
    public void devePermitirChaveComCnpjTotalmenteAlfanumerico() {
        ...
        Assertions.assertEquals("12ABC34501DE35", parser.getCnpjEmitente());
    }
    ...
    public void devePermitirChaveComCnpjTotalmenteNumerico() {
        ...
        Assertions.assertEquals("12345678901234", parser.getCnpjEmitente());
    }

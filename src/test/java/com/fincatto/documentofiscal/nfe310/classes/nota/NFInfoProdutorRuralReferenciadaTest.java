...
public class NFInfoProdutorRuralReferenciadaTest {
    ...
    public void naoDevePermitirSerieDocumentoFiscalComTamanhoInvalido() {
        Assertions.assertThrows(NumberFormatException.class, () -> new NFInfoProdutorRuralReferenciada().setSerieDocumentoFiscal(1000));
    }

    @Test
    public void naoDevePermitirNumeroDocumentoFiscalComTamanhoInvalido() {
        Assertions.assertThrows(NumberFormatException.class, () -> new NFInfoProdutorRuralReferenciada().setNumeroDocumentoFiscal(1000000000));
    }
    ...
    public void deveGerarXMLDeAcordoComOPadraoEstabelecido() {
        ...
        Assertions.assertEquals(xmlEsperado, referenciada.toString());
    }
}
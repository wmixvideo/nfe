...
public class NFProtocoloEventoCancelamentoTest {
    ...
    public void deveObterEventoComoFoiSetado() {
        ...
        Assertions.assertEquals(FabricaDeObjetosFake.getNFEventoCancelamento().getVersao(), procEvento.getEvento().getVersao());
    }
    ...
    public void deveObterEventoRetornoComoFoiSetado() {
        ...
        Assertions.assertEquals(eventoRetorno.getVersao(), procEvento.getInfoEventoRetorno().getVersao());
    }
    ...
    public void deveGerarXMLDeAcordoComOPadraoEstabelecido() {
        ...
        Assertions.assertEquals(xmlEsperado, procEvento.toString());
    }
}

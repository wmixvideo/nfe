...
public class DFDateTimeTransformerTest {
    ...
    public void deveTestarLeitura() {
        Assertions.assertNotNull(new DFDateTimeTransformer().read("2017-09-27T15:03:02-03:00"));
    }
    ...
    public void deveTestarEscrita() {
        ...
        Assertions.assertEquals(data, new DFDateTimeTransformer().write(dataEsperada));
    }

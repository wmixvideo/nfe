...
public class NFNotaInfoTest {
    ...
    public void naoDevePermitirIdentificadorComTamanhoInvalido() {
        try {
            ...
            new NFNotaInfo().setIdentificador("ChZ9G0aubajFyQkslfhicTyzggacyZlAtWJrlrvS4JIskg31");
        }
    }

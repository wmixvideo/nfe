...
public class FabricaDeObjetosFakeNFe {
    ...
    public static NFImpostoDevolvido getNFImpostoDevolvido() {
        ...
        impostoDevolvido.setInformacaoIPIDevolvido(FabricaDeObjetosFakeNFe.getNFInformacaoImpostoDevolvido());
    ...
    public static NFInfoEventoCancelamento getNFInfoEventoCancelamento() {
        ...
        infoEventoCancelamento.setCancelamento(FabricaDeObjetosFakeNFe.getNFInfoCancelamento());
    ...
    public static NFEnviaEventoInutilizacao getNFEnviaEventoInutilizacao() {
        ...
        enviaEvento.setVersao(new BigDecimal("1.00"));
        enviaEvento.setDados(FabricaDeObjetosFakeNFe.getNFEventoInutilizacaoDados());
        return enviaEvento;
    }
    ...
    public static NFEventoManifestacaoDestinatario getNFEventoManifestacaoDestinatario() {
        ...
        eventoManifestacaoDestinatario.setInfoEvento(FabricaDeObjetosFakeNFe.getNFInfoEventoManifestacaoDestinatario());
    ...
    public static NFInfoEventoManifestacaoDestinatario getNFInfoEventoManifestacaoDestinatario() {
        ...
        infoEventoManifestacaoDestinatario.setManifestacaoDestinatario(FabricaDeObjetosFakeNFe.getNFInfoManifestacaoDestinatario());
    ...
    public static NFEvento getNFEventoCartaCorrecao() {
        ...
        evento.setInfoEvento(FabricaDeObjetosFakeNFe.getNFInfoEventoCartaCorrecao());
    ...
    public static NFInfoEvento getNFInfoEventoCartaCorrecao() {
        ...
        infoEvento.setDadosEvento(FabricaDeObjetosFakeNFe.getNFInfoCartaCorrecao());
    ...
    public static NFNotaInfoPagamento getNFNotaInfoPagamento() {
        ...
        pagamento.setCartao(FabricaDeObjetosFakeNFe.getNFNotaInfoCartao());
    ...
    public static NFLoteEnvio getNFLoteEnvio() {
        ...
        loteEnvio.setNotas(Collections.singletonList(FabricaDeObjetosFakeNFe.getNFNota1()));
    ...
    public static NFNota getNFNota1() {
        ...
        info.setAvulsa(FabricaDeObjetosFakeNFe.getNFNotaInfoAvulsa());
        info.setCana(FabricaDeObjetosFakeNFe.getNFNotaInfoCana());
        info.setCobranca(FabricaDeObjetosFakeNFe.getNFNotaInfoCobranca());
        info.setCompra(FabricaDeObjetosFakeNFe.getNFNotaInfoCompra());
        info.setDestinatario(FabricaDeObjetosFakeNFe.getNFNotaInfoDestinatario());
        info.setEmitente(FabricaDeObjetosFakeNFe.getNFNotaInfoEmitente());
        info.setEntrega(FabricaDeObjetosFakeNFe.getNFNotaInfoLocal());
        info.setExportacao(FabricaDeObjetosFakeNFe.getNFNotaInfoExportacao());
        info.setIdentificador("89172658591754401086218048846976493475937081");
        info.setInformacoesAdicionais(FabricaDeObjetosFakeNFe.getNFNotaInfoInformacoesAdicionais());
        info.setPessoasAutorizadasDownloadNFe(Collections.singletonList(FabricaDeObjetosFakeNFe.getPessoaAutorizadaDownloadNFe()));
        ...
        imposto.setIssqn(FabricaDeObjetosFakeNFe.getNFNotaInfoItemImpostoISSQN());
        ...
        item.setProduto(FabricaDeObjetosFakeNFe.getProdutoMedicamento());
        item.setImpostoDevolvido(FabricaDeObjetosFakeNFe.getNFImpostoDevolvido());

        info.setItens(Collections.singletonList(item));
        info.setRetirada(FabricaDeObjetosFakeNFe.getNFNotaInfoLocal());
        info.setTotal(FabricaDeObjetosFakeNFe.getNFNotaInfoTotal());
        info.setTransporte(FabricaDeObjetosFakeNFe.getNFNotaInfoTransporte());
    ...
    private static NFNotaInfoItemProduto getProdutoMedicamento() {
        ...
        produtoMedicamento.setDeclaracoesImportacao(Collections.singletonList(FabricaDeObjetosFakeNFe.getNFNotaInfoItemProdutoDeclaracaoImportacao()));
        ...
        produtoMedicamento.setVeiculo(FabricaDeObjetosFakeNFe.getNFNotaInfoItemProdutoVeiculo());
    ...
    public static NFNotaProcessada getNFNotaProcessada() {
        ...
        notaProcessada.setNota(FabricaDeObjetosFakeNFe.getNFNota1());
        notaProcessada.setProtocolo(FabricaDeObjetosFakeNFe.getNFProtocolo());
    ...
    public static NFProtocolo getNFProtocolo() {
        ...
        protocolo.setProtocoloInfo(FabricaDeObjetosFakeNFe.getNFProtocoloInfo());
    ...
    public static NFNotaInfo getNFNotaInfo() {
        ...
        info.setEntrega(FabricaDeObjetosFakeNFe.getNFNotaInfoLocal());
        info.setExportacao(FabricaDeObjetosFakeNFe.getNFNotaInfoExportacao());
        info.setPagamentos(Collections.singletonList(FabricaDeObjetosFakeNFe.getNFNotaInfoPagamento()));
        info.setIdentificacao(FabricaDeObjetosFakeNFe.getNFNotaInfoIdentificacao());
        info.setIdentificador("89172658591754401086218048846976493475937081");
        info.setInformacoesAdicionais(FabricaDeObjetosFakeNFe.getNFNotaInfoInformacoesAdicionais());
        info.setItens(Collections.singletonList(FabricaDeObjetosFakeNFe.getNFNotaInfoItem()));
        info.setRetirada(FabricaDeObjetosFakeNFe.getNFNotaInfoLocal());
        info.setTotal(FabricaDeObjetosFakeNFe.getNFNotaInfoTotal());
        info.setTransporte(FabricaDeObjetosFakeNFe.getNFNotaInfoTransporte());
        info.setVersao(new BigDecimal("3.10"));
    ...
    public static NFNotaInfoTransporte getNFNotaInfoTransporte() {
        ...
        transporte.setIcmsTransporte(FabricaDeObjetosFakeNFe.getNFNotaInfoRetencaoICMSTransporte());
        transporte.setModalidadeFrete(NFModalidadeFrete.SEM_FRETE);
        transporte.setReboques(Collections.singletonList(FabricaDeObjetosFakeNFe.getNFNotaInfoReboque()));
        transporte.setTransportador(FabricaDeObjetosFakeNFe.getNFNotaInfoTransportador());
        transporte.setVolumes(Collections.singletonList(FabricaDeObjetosFakeNFe.getNFNotaInfoVolume()));
        return transporte;
    }
    ...
    public static NFNotaInfoItem getNFNotaInfoItem() {
        final NFNotaInfoItem item = new NFNotaInfoItem();
        item.setImposto(FabricaDeObjetosFakeNFe.getNFNotaInfoItemImposto());
        ...
        item.setNumeroItem(990);
        item.setProduto(FabricaDeObjetosFakeNFe.getNFNotaInfoItemProduto());
        item.setImpostoDevolvido(FabricaDeObjetosFakeNFe.getNFImpostoDevolvido());
        return item;
    }
    ...
    public static NFNotaInfoInformacoesAdicionais getNFNotaInfoInformacoesAdicionais() {
        ...
        observacoesFisco.add(FabricaDeObjetosFakeNFe.getNFNotaInfoObservacao());
        ...
        observacoesContribuinte.add(FabricaDeObjetosFakeNFe.getNFNotaInfoObservacao());
        ...
        processosRefenciado.add(FabricaDeObjetosFakeNFe.getNFNotaInfoProcessoReferenciado());
    ...
    public static NFNotaInfoIdentificacao getNFNotaInfoIdentificacao() {
        ...
        identificacao.setNumeroNota("999999999");
        identificacao.setProgramaEmissor(NFProcessoEmissor.CONTRIBUINTE);
        identificacao.setReferenciadas(Collections.singletonList(FabricaDeObjetosFakeNFe.getNFInfoReferenciada()));
        identificacao.setSerie("999");
        identificacao.setTipo(NFTipo.ENTRADA);
        identificacao.setTipoEmissao(DFTipoEmissao.EMISSAO_NORMAL);
        identificacao.setTipoImpressao(NFTipoImpressao.DANFE_NORMAL_PAISAGEM);
    ...
    public static NFNotaInfoDestinatario getNFNotaInfoDestinatario() {
        ...
        destinatario.setEndereco(FabricaDeObjetosFakeNFe.getNFEndereco());
    ...
    public static NFNotaInfoCobranca getNFNotaInfoCobranca() {
        ...
        cobranca.setDuplicatas(Collections.singletonList(FabricaDeObjetosFakeNFe.getNFNotaInfoDuplicata()));
        return cobranca;
    }
    ...
    public static NFNotaInfoItemDetalheExportacao getNFNotaInfoItemDetalheExportacao() {
        ...
        detalheExportacao.setExportacaoIndireta(FabricaDeObjetosFakeNFe.getNFNotaInfoItemExportacaoIndireta());
    ...
    public static NFNotaInfoItemProduto getNFNotaInfoItemProduto() {
        ...
        produto.setDeclaracoesImportacao(Collections.singletonList(FabricaDeObjetosFakeNFe.getNFNotaInfoItemProdutoDeclaracaoImportacao()));
        ...
        produto.setMedicamentos(Collections.singletonList(FabricaDeObjetosFakeNFe.getNFNotaInfoItemProdutoMedicamento()));
    ...
    public static NFNotaInfoItemProdutoDeclaracaoImportacao getNFNotaInfoItemProdutoDeclaracaoImportacao() {
        ...
        declaraoImportacao.setAdicoes(Collections.singletonList(FabricaDeObjetosFakeNFe.getNFNotaInfoItemProdutoDeclaracaoImportacaoAdicao()));
    ...
    public static NFNotaInfoItemImpostoIPI getNFNotaInfoItemImpostoIPI() {
        ...
        ipi.setTributado(FabricaDeObjetosFakeNFe.getNFNotaInfoItemImpostoIPITributado());
        return ipi;
    }
    ...
    public static NFNotaInfoItemImpostoICMS getNFNotaInfoItemImpostoICMS() {
        ...
        icms.setIcms00(FabricaDeObjetosFakeNFe.getNFNotaInfoItemImpostoICMS00());
        return icms;
    }

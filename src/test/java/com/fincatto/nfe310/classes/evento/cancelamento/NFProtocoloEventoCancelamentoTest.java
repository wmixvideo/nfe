...
public class NFProtocoloEventoCancelamentoTest {
    ...
    public void deveObterEventoComoFoiSetado() {
        final NFProtocoloEventoCancelamento procEvento = new NFProtocoloEventoCancelamento();
        procEvento.setEvento(FabricaDeObjetosFakeNFe.getNFEventoCancelamento());
        Assert.assertEquals(FabricaDeObjetosFakeNFe.getNFEventoCancelamento().getVersao(), procEvento.getEvento().getVersao());
    }

...
public class NFEventoManifestacaoTest {
    ...
    public void deveObterInfoEventoManifestacaoDestinatarioComoFoiSetado() {
        ...
        Assert.assertEquals(FabricaDeObjetosFakeNFe.getNFInfoEventoManifestacaoDestinatario().toString(), eventoManifestacaoDestinatario.getInfoEvento().toString());
    }
    ...
    public void deveGerarXMLDeAcordoComOPadraoEstabelecido() {
        ...
        Assert.assertEquals(xmlEsperado, FabricaDeObjetosFakeNFe.getNFEventoManifestacaoDestinatario().toString());
    }
}
...
public class NFAutorizador31Test {
    ...
    public void deveObterSVCRS() {
        Assert.assertEquals(NFAutorizador31.SVRS, NFAutorizador31.valueOfTipoEmissao(DFTipoEmissao.CONTINGENCIA_SVCRS, DFUnidadeFederativa.RS));
    }

    @Test
    public void deveObterSVCAN() {
        Assert.assertEquals(NFAutorizador31.SCAN, NFAutorizador31.valueOfTipoEmissao(DFTipoEmissao.CONTINGENCIA_SVCAN, DFUnidadeFederativa.RS));
    }

    @Test
    public void deveObterEmissorNormal() {
        Assert.assertEquals(NFAutorizador31.RS, NFAutorizador31.valueOfTipoEmissao(DFTipoEmissao.EMISSAO_NORMAL, DFUnidadeFederativa.RS));
    }

...
public class NFNotaInfoTest {
    ...
    public void deveObterIdentificacaoComoFoiSetado() {
        final NFNotaInfo notaInfo = new NFNotaInfo();
        final NFNotaInfoIdentificacao identificacao = FabricaDeObjetosFakeNFe.getInfoIdentificacaoDeTeste();
    ...
    public void deveObterEmitenteComoFoiSetado() {
        final NFNotaInfo notaInfo = new NFNotaInfo();
        final NFNotaInfoEmitente emitente = FabricaDeObjetosFakeNFe.getNFNotaInfoEmitente();
    ...
    public void deveObterAvulsaComoFoiSetado() {
        final NFNotaInfo notaInfo = new NFNotaInfo();
        final NFNotaInfoAvulsa avulsa = FabricaDeObjetosFakeNFe.getNFNotaInfoAvulsa();
    ...
    public void deveObterDestinatarioComoFoiSetado() {
        final NFNotaInfo notaInfo = new NFNotaInfo();
        final NFNotaInfoDestinatario destinatario = FabricaDeObjetosFakeNFe.getNFNotaInfoDestinatario();
    ...
    public void deveObterRetiradaComoFoiSetado() {
        final NFNotaInfo notaInfo = new NFNotaInfo();
        final NFNotaInfoLocal retirada = FabricaDeObjetosFakeNFe.getNFNotaInfoLocal();
    ...
    public void deveObterEntregaComoFoiSetado() {
        final NFNotaInfo notaInfo = new NFNotaInfo();
        final NFNotaInfoLocal entrega = FabricaDeObjetosFakeNFe.getNFNotaInfoLocal();
    ...
    public void deveObterPessoasAutorizadasDownloadNFeComoFoiSetado() {
        final NFNotaInfo notaInfo = new NFNotaInfo();
        final List<NFPessoaAutorizadaDownloadNFe> pessoasAutorizadasDownloadNFe = Collections.singletonList(FabricaDeObjetosFakeNFe.getPessoaAutorizadaDownloadNFe());
    ...
    public void deveObterItensComoFoiSetado() {
        final NFNotaInfo notaInfo = new NFNotaInfo();
        final List<NFNotaInfoItem> itens = Collections.singletonList(FabricaDeObjetosFakeNFe.getNFNotaInfoItem());
    ...
    public void deveObterTotalComoFoiSetado() {
        final NFNotaInfo notaInfo = new NFNotaInfo();
        final NFNotaInfoTotal total = FabricaDeObjetosFakeNFe.getNFNotaInfoTotal();
    ...
    public void deveObterTransporteComoFoiSetado() {
        final NFNotaInfo notaInfo = new NFNotaInfo();
        final NFNotaInfoTransporte transporte = FabricaDeObjetosFakeNFe.getNFNotaInfoTransporte();
    ...
    public void deveObterCobrancaComoFoiSetado() {
        final NFNotaInfo notaInfo = new NFNotaInfo();
        final NFNotaInfoCobranca cobranca = FabricaDeObjetosFakeNFe.getNFNotaInfoCobranca();
    ...
    public void deveObterPagamentosComoFoiSetado() {
        final NFNotaInfo notaInfo = new NFNotaInfo();
        final List<NFNotaInfoPagamento> pagamentos = Collections.singletonList(FabricaDeObjetosFakeNFe.getNFNotaInfoPagamento());
    ...
    public void deveObterInformacoesAdicionaisComoFoiSetado() {
        final NFNotaInfo notaInfo = new NFNotaInfo();
        final NFNotaInfoInformacoesAdicionais informacoesAdicionais = FabricaDeObjetosFakeNFe.getNFNotaInfoInformacoesAdicionais();
    ...
    public void deveObterExportacaoComoFoiSetado() {
        final NFNotaInfo notaInfo = new NFNotaInfo();
        final NFNotaInfoExportacao exportacao = FabricaDeObjetosFakeNFe.getNFNotaInfoExportacao();
    ...
    public void deveObterCompraComoFoiSetado() {
        final NFNotaInfo notaInfo = new NFNotaInfo();
        final NFNotaInfoCompra compra = FabricaDeObjetosFakeNFe.getNFNotaInfoCompra();
    ...
    public void deveObterCanaComoFoiSetado() {
        final NFNotaInfo notaInfo = new NFNotaInfo();
        final NFNotaInfoCana cana = FabricaDeObjetosFakeNFe.getNFNotaInfoCana();
    ...
    public void deveGerarXMLDeAcordoComOPadraoEstabelecido() {
        ...
        Assert.assertEquals(xmlEsperado, FabricaDeObjetosFakeNFe.getNFNotaInfo().toString());
    }
}